...
class BlogServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        add_filter('data_synchronize_import_form_before', function (?string $html, Importer $importer): ?string {
            if ($importer instanceof PostImporter) {
                return $html . view('plugins/blog::posts.partials.post-import-extra-fields')->render();
            }
        ...
        add_filter('data_synchronize_import_form_before', function (?string $html, Importer $importer): ?string {
            if ($importer instanceof ModelTranslationImporter && $importer->isForModel(Post::class)) {
                return $html . view('plugins/blog::posts.partials.post-translation-import-extra-fields')->render();
            }
