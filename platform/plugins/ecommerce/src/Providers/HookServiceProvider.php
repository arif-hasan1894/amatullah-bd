...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        add_filter('data_synchronize_import_form_before', function (?string $html, Importer $importer): ?string {
            if ($importer instanceof ProductCategoryImporter) {
                return $html . view('plugins/ecommerce::product-categories.partials.product-category-import-extra-fields')->render();
            }
            ...
            // AMATULLAH_PRODUCT_SPEC_IMPORT_UI_ALL_IN_ONE
            if ($importer instanceof ProductSpecificationImporter) {
                return $html . view('plugins/ecommerce::products.partials.product-specification-import-extra-fields')->render();
            }

            // AMATULLAH_PRODUCT_PRICE_IMPORT_UI_V1
            if ($importer instanceof ProductPriceImporter) {
                return $html . view('plugins/ecommerce::products.partials.product-price-import-extra-fields')->render();
            }
