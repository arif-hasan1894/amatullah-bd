...
app()->booted(function (): void {
    ...
    // Render above-the-fold homepage blocks server-side instead of lazy-loading
    // them. These sit within the first mobile viewport, so swapping their skeleton
    // placeholders for the real content shifts the whole page down — a large
    // Cumulative Layout Shift. Lazy-loading only pays off for below-the-fold
    // content; above the fold it hurts both CLS and LCP.
    shortcode()->ignoreLazyLoading(['site-features', 'flash-sale']);
