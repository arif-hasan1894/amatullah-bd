                        ...
                        <div class="ps-block__content">
                            ...
                            @if ($androidAppUrl || $iosAppUrl)
                                <p class="download-link">
                                    @if ($androidAppUrl)
                                        <a href="{{ (string) $androidAppUrl }}"><img src="{{ Theme::asset()->url('img/google-play.png') }}" alt="{{ __('Google Play') }}" width="127" height="43" loading="lazy"></a>
                                    @endif

                                    @if ($iosAppUrl)
                                        <a href="{{ (string) $iosAppUrl }}"><img src="{{ Theme::asset()->url('img/app-store.png') }}" alt="{{ __('App Store') }}" width="128" height="43" loading="lazy"></a>
                                    @endif
                                </p>
                            @endif
                        </div>
