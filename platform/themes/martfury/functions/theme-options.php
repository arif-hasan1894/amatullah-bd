...
app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
    theme_option()
        ...
        ->setField([
            ...
            'section_id' => 'opt-text-subsection-style',
            'type' => 'customColor',
            'label' => __('Footer text link color'),
            'attributes' => [
                'name' => 'footer_text_link_color',
                'value' => '#666',
            ],
        ])
        ->setField([
            ...
            'section_id' => 'opt-text-subsection-style',
            'type' => 'customColor',
            'label' => __('Footer text link hover color'),
            'attributes' => [
                'name' => 'footer_text_link_hover_color',
                'value' => '#fcb800',
            ],
        ])
        ->setField([
        ...
        ->setField([
            ...
            'section_id' => 'opt-text-subsection-general',
            'type' => 'customSelect',
            'label' => __('Show back to top button?'),
            'attributes' => [
