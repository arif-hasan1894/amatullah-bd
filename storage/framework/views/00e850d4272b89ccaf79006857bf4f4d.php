...
<?php $component->withAttributes([]); ?>
            <a
                ...
                href="#<?php echo e($id); ?>"
                aria-expanded="<?php echo e(Str::slug($name) === 'pages' ? 'true' : false); ?>"
            >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.body.index','data' => ['class' => 'overflow-auto','style' => 'max-height: 20rem;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'overflow-auto','style' => 'max-height: 20rem;']); ?>
                <div class="the-box">
                    <?php echo $options; ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/packages/menu/resources/views/menu-options.blade.php ENDPATH**/ ?>