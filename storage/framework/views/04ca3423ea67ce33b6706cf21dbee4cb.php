...
<?php endif; ?>
                        ...
                        <div>
                            <div class="text-muted small"><?php echo e(trans('plugins/ecommerce::products.pending_orders')); ?></div>
                            <div class="h3 m-0"><?php echo e(number_format($pendingOrders)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        <span class="bg-lime text-white avatar me-3">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-clock-dollar'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <div class="text-muted small"><?php echo e(trans('plugins/ecommerce::products.pending_revenue')); ?></div>
                            <div class="h3 m-0"><?php echo e(format_price($pendingRevenue)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        <span class="bg-purple text-white avatar me-3">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-percentage'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <div class="text-muted small"><?php echo e(trans('plugins/ecommerce::products.conversion_rate')); ?></div>
                            <div class="h3 m-0"><?php echo e(number_format($conversionRate, 2)); ?>%</div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                    ...
                    <div class="p-3 border-top">
                        <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="btn btn-primary w-100 mb-2">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                                    <a href="<?php echo e(route('orders.edit', $orderProduct->order->id)); ?>">
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/view.blade.php ENDPATH**/ ?>