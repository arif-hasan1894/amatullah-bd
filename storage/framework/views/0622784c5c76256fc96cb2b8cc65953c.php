...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'alert-icon me-2']); ?>
...
<?php endif; ?>
                        <strong><?php echo e(trans('plugins/ecommerce::order.payment_proof')); ?></strong>
                    </div>
                </div>
                <div class="ms-3">
                    <a href="<?php echo e($downloadUrl ?? route('orders.download-proof', $order->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        <?php echo e(trans('plugins/ecommerce::order.download')); ?>
...
<?php $attributes = $attributes->except(\Botble\Icon\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-1','style' => 'font-size: 14px;']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73995948b3bd877b76251b40caf28170)): ?>
<?php $attributes = $__attributesOriginal73995948b3bd877b76251b40caf28170; ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <span title="<?php echo e($fileName); ?>"><?php echo e($displayName); ?></span>
                </div>
                <?php if($fileInfo): ?>
                    <div>
                        <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                        <?php echo e(__('Uploaded')); ?>: <?php echo e(Carbon\Carbon::createFromTimestamp($fileInfo)->format('M d, Y H:i')); ?>
...
<?php endif; ?>
</div><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/orders/partials/payment-proof-detail.blade.php ENDPATH**/ ?>