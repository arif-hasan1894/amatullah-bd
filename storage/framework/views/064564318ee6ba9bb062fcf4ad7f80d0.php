...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => ''.e(route('ecommerce.invoice.generate-invoice', ['invoice' => $invoice, 'type' => 'print'])).'','target' => '_blank','icon' => 'ti ti-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => ''.e(route('ecommerce.invoice.generate-invoice', ['invoice' => $invoice, 'type' => 'print'])).'','target' => '_blank','icon' => 'ti ti-printer']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['href' => ''.e(route('ecommerce.invoice.generate-invoice', ['invoice' => $invoice, 'type' => 'download'])).'','tag' => 'a','target' => '_blank','icon' => 'ti ti-download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('ecommerce.invoice.generate-invoice', ['invoice' => $invoice, 'type' => 'download'])).'','tag' => 'a','target' => '_blank','icon' => 'ti ti-download']); ?>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-6 text-end">
                        <ul class="list-unstyled">
                            <?php if($customerName = $invoice->customer_name): ?>
                                <li><?php echo e($customerName); ?></li>
                            <?php endif; ?>
                            <?php if($customerEmail = $invoice->customer_email): ?>
                                <li><?php echo e($customerEmail); ?></li>
                            <?php endif; ?>
                            <?php if($customerPhone = $invoice->customer_phone): ?>
                                <li><?php echo e($customerPhone); ?></li>
                            <?php endif; ?>
                            <?php if($customerAddress = $invoice->customer_address): ?>
                                <li><?php echo e($customerAddress); ?></li>
                            <?php endif; ?>

                            <?php if($customerTaxID = $invoice->customer_tax_id): ?>
                                <li><?php echo e(__('Tax ID:')); ?> <?php echo e($customerTaxID); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::datagrid.index','data' => ['class' => 'mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                     <?php $__env->slot('title', null, []); ?> 
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.code')); ?>
...
<?php $component->withAttributes([]); ?>
                                         <?php $__env->slot('title', null, []); ?> 
                                            <?php echo e(trans('plugins/ecommerce::invoice.detail.issue_at')); ?>
...
<?php endif; ?>
                                <?php endif; ?>
                                <?php if(is_plugin_active('payment') && $invoice->payment->payment_channel->displayName()): ?>
                                    <?php if (isset($component)) { $__componentOriginal9d1723e55a4fe6f8bd7b5292f882d2ac = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9d1723e55a4fe6f8bd7b5292f882d2ac = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::datagrid.item','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::datagrid.item'); ?>
...
<?php $component->withAttributes([]); ?>
                                         <?php $__env->slot('title', null, []); ?> 
                                            <?php echo e(trans('plugins/ecommerce::invoice.payment_method')); ?>
...
<?php $component->withAttributes([]); ?>
                                                <img
                                                    src="<?php echo e(RvMedia::getImageUrl($invoiceItem->image, 'thumb', false, RvMedia::getDefaultImage())); ?>"
                                                    alt="<?php echo e($invoiceItem->name); ?>"
                                                    width="50"
                                                >
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                                <?php if($product && $product->original_product?->url): ?>
                                                    <a href="<?php echo e($product->original_product->url); ?>"><?php echo BaseHelper::clean($invoiceItem->name); ?></a>
                                                <?php else: ?>
                                                    <?php echo BaseHelper::clean($invoiceItem->name); ?>

                                                <?php endif; ?>
                                                <?php if($sku = Arr::get($invoiceItem->options, 'sku')): ?>
                                                    (<?php echo e($sku); ?>)
                                                <?php endif; ?>

                                                <?php if($attributes = Arr::get($invoiceItem->options, 'attributes')): ?>
                                                    <p class="mb-0 small">
                                                ...
                                                <p class="mb-0 small">
                                                    <?php echo BaseHelper::clean($invoiceItem->product_options_implode); ?>

                                                </p>

                                                <?php if(is_plugin_active('marketplace') && ($product = $invoiceItem->reference) && $product->original_product->store?->id): ?>
                                                    <p class="mb-0 small">
                                                        <?php echo e(__('Sold by')); ?>

                                                        <a href="<?php echo e($product->original_product->store->url); ?>" class="text-primary">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                                <?php echo e($invoiceItem->amount_format); ?>
...
<?php endif; ?>
                                            <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'money']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'money']); ?>
                                                <strong>
                                                    <?php echo e($invoiceItem->total_format); ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginaldcb08e3108bb7995dc0eca96e4f3277a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldcb08e3108bb7995dc0eca96e4f3277a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.footer.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.footer'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '4']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.quantity')); ?>
...
<?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'fw-bold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                        <?php echo e(number_format($invoice->items->sum('qty'))); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.sub_total')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                        <?php echo e(format_price($invoice->sub_total)); ?>
...
<?php unset($__componentOriginal6776c17865a79e242405889703595892); ?>
<?php endif; ?>
                                <?php echo apply_filters('ecommerce_admin_invoice_after_subtotal', null, $invoice); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                            <?php echo e(trans('plugins/ecommerce::invoice.detail.tax')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                            <?php echo e(format_price($invoice->tax_amount)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.shipping_fee')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                        <?php echo e(format_price($invoice->shipping_amount)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.discount')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                        <?php echo e(format_price($invoice->discount_amount)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.detail.grand_total')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fw-bold']); ?>
                                        <?php echo e(format_price($invoice->amount)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e(trans('plugins/ecommerce::invoice.total_amount')); ?>
...
<?php endif; ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldcb08e3108bb7995dc0eca96e4f3277a)): ?>
<?php $attributes = $__attributesOriginaldcb08e3108bb7995dc0eca96e4f3277a; ?>
<?php unset($__attributesOriginaldcb08e3108bb7995dc0eca96e4f3277a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldcb08e3108bb7995dc0eca96e4f3277a)): ?>
<?php $component = $__componentOriginaldcb08e3108bb7995dc0eca96e4f3277a; ?>
<?php unset($__componentOriginaldcb08e3108bb7995dc0eca96e4f3277a); ?>
<?php endif; ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="mt-3">
                        <?php if($invoice->reference && $invoice->reference->id): ?>
...
<?php $component->withAttributes([]); ?>
                                <small>
                                    <?php echo e(trans('plugins/ecommerce::invoice.detail.invoice_for')); ?>:
                                    <a href="<?php echo e(route('orders.edit', $invoice->reference->id)); ?>" target="_blank">
                                        <?php echo e($invoice->reference->code); ?>
...
<?php endif; ?>
                        ...
                        <p class="font-sm">
                            <?php if($invoice->company_name): ?>
                                <strong><?php echo e(trans('plugins/ecommerce::invoice.detail.invoice_to')); ?>:</strong>
                                <?php echo e($invoice->company_name); ?><br>
                            <?php endif; ?>

                            <?php if($invoice->customer_tax_id): ?>
                                <strong><?php echo e(trans('plugins/ecommerce::invoice.detail.tax_id')); ?>:</strong>
                                <?php echo e($invoice->customer_tax_id); ?><br>
                            <?php endif; ?>

                            <?php echo apply_filters('ecommerce_admin_invoice_extra_info', null, $invoice->reference); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/invoices/edit.blade.php ENDPATH**/ ?>