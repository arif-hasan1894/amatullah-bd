...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['striped' => false,'hover' => false,'class' => 'table-bordered']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['striped' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hover' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'table-bordered']); ?>
...
<?php $component->withAttributes([]); ?>
            <?php $__currentLoopData = $shipment->order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'text-center','style' => 'width: 5%']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center','style' => 'width: 5%']); ?>
...
<?php $component->withAttributes([]); ?>
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                <a
                                    class="d-print-none"
                                    href="<?php echo e($productEditRouteName && $product && $product->id ? route($productEditRouteName, $product->id) : '#'); ?>"
                                ...
                                <?php if($sku = Arr::get($orderProduct->options, 'sku') ?: ($product && $product->sku ? $product->sku : null)): ?>
                                    <p class="small mb-0">
                                        <?php echo e(trans('plugins/ecommerce::shipping.sku')); ?>: <strong><?php echo e($sku); ?></strong>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                        <strong><?php echo e($orderProduct->qty); ?></strong>
                        <span>×</span>
                        <strong><?php echo e(format_price($orderProduct->price)); ?></strong>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                        <span><?php echo e(format_price($orderProduct->price * $orderProduct->qty)); ?></span>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.footer.index','data' => ['class' => 'text-center py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center py-2']); ?>
            <a
                href="<?php echo e(route($orderEditRouteName, $shipment->order_id)); ?>"
                target="_blank"
            >
                <?php echo e(trans('plugins/ecommerce::shipping.view_order', ['order_id' => $shipment->order->code])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipments/products.blade.php ENDPATH**/ ?>