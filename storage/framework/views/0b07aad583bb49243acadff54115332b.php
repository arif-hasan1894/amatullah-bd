...
<?php endif; ?>
        <?php endif; ?>
        <div class="avatar-view rounded-<?php echo e($rounded); ?> overflow-hidden">
            <img <?php echo e($attributes->merge(['class' => $imageClasses, 'src' => $value, 'alt' => $label])); ?> />

            <?php if(!$hiddenCropper || $canDelete): ?>
                <div class="backdrop"></div>
                <div class="action">
                    <?php if(!$hiddenCropper): ?>
                        <a
                            href="javascript:void(0);"
                            class="text-decoration-none text-white"
                            data-bs-toggle="modal"
                            data-bs-target="#<?php echo e($name); ?>-modal"
                        >
...
<?php endif; ?>
        ...
        <?php if($showChooseImageLink && !$hiddenCropper): ?>
            <a
                href="javascript:void(0);"
                data-bs-toggle="modal"
                data-bs-target="#<?php echo e($name); ?>-modal"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['id' => ''.e($name).'-modal','title' => trans('core/base::forms.crop_image_update', ['name' => $label]),'size' => 'lg','class' => 'crop-image-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => ''.e($name).'-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::forms.crop_image_update', ['name' => $label])),'size' => 'lg','class' => 'crop-image-modal']); ?>
            <div class="row">
                <div class="col-md-8">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => $label,'name' => $name,'type' => 'file','accept' => 'image/*']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($label),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($name),'type' => 'file','accept' => 'image/*']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'submit','color' => 'primary','class' => 'ms-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','color' => 'primary','class' => 'ms-auto']); ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/base/resources/views/components/crop-image.blade.php ENDPATH**/ ?>