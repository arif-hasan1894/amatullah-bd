...
<?php $component->withAttributes(['class' => 'p-0']); ?>
        <div class="p-3">
            <div class="mb-3">
                <span class="avatar avatar-lg avatar-rounded" style="background-image: url('<?php echo e($returnRequest->customer->id ? $returnRequest->customer->avatar_url : $returnRequest->order->address->avatar_url); ?>')"></span>
            </div>

            <p class="mb-1 fw-semibold"><?php echo e($returnRequest->customer->name ?: $returnRequest->order->address->name); ?></p>

            <?php if($returnRequest->customer->id): ?>
                <p class="mb-1">
...
<?php endif; ?>
                    <?php echo e($returnRequest->customer->completedOrders()->count()); ?>
            ...
            <p class="mb-1">
                <a href="mailto:<?php echo e($email = ($returnRequest->customer->email ?: $returnRequest->order->address->email)); ?>">
                    <?php echo e($email); ?>
        ...
        <div class="p-3">
            <h4><?php echo e(trans('plugins/ecommerce::order.address')); ?></h4>

            <dl class="mb-0">
                <dd><?php echo e($returnRequest->order->address->name); ?></dd>
                <dd>
                    <a href="tel:<?php echo e($phone = $returnRequest->order->address->phone); ?>">
                        <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php endif; ?>
                ...
                <dd><?php echo e($returnRequest->order->address->full_address); ?></dd>
                <dd>
                    <a
                        href="https://maps.google.com/?q=<?php echo e($returnRequest->full_address); ?>"
                        target="_blank"
                    >
                        <?php echo e(trans('plugins/ecommerce::order.see_maps')); ?>
        ...
        <div class="p-3">
            <h4 class="mb-2"><?php echo e(trans('plugins/ecommerce::order.return_reason')); ?></h4>

            <p class="text-danger mb-0">
                <?php if($returnRequest->reason->label()): ?>
                    <?php echo BaseHelper::clean($returnRequest->reason->toHtml()); ?>

                <?php else: ?>
                    <?php $__currentLoopData = $returnRequest->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $returnItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo BaseHelper::clean($returnItem->reason->toHtml()); ?><?php if(! $loop->last): ?>, <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/order-returns/partials/customer-information.blade.php ENDPATH**/ ?>