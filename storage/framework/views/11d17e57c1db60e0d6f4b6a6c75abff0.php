...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['url' => route('ecommerce.settings.shipping-label-template.update'),'method' => 'PUT']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('ecommerce.settings.shipping-label-template.update')),'method' => 'PUT']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'cbdd3a194c072fbc3f04e785bd9366eb::section','data' => ['title' => trans('plugins/ecommerce::shipping-label-template.setting'),'description' => trans('plugins/ecommerce::shipping-label-template.setting_description')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.setting')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.setting_description'))]); ?>
...
<?php $component->withAttributes(['for' => 'email_content']); ?>
                    <?php echo e(trans('plugins/ecommerce::shipping-label-template.setting_content')); ?>
...
<?php $component->withAttributes([]); ?>
                <?php if (isset($component)) { $__componentOriginal50e5e771b30c35423d2b4f118feb7c0c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal50e5e771b30c35423d2b4f118feb7c0c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.label','data' => ['for' => 'shipping_label_template_custom_css']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::form.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'shipping_label_template_custom_css']); ?>
                    <?php echo e(trans('plugins/ecommerce::shipping-label-template.custom_css')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.code-editor','data' => ['name' => 'shipping_label_template_custom_css','mode' => 'css','value' => setting('shipping_label_template_custom_css')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'shipping_label_template_custom_css','mode' => 'css','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(setting('shipping_label_template_custom_css'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('plugins/ecommerce::shipping-label-template.custom_css_helper')); ?>
...
<?php $component->withAttributes(['class' => 'btn-trigger-reset-to-default','icon' => 'ti ti-arrow-back-up','data-bb-toggle' => 'reset-default']); ?>
                    <?php echo e(trans('plugins/ecommerce::shipping-label-template.reset_to_default')); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['target' => '_blank','tag' => 'a','href' => ''.e(route('ecommerce.settings.shipping-label-template.preview')).'','icon' => 'ti ti-eye']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['target' => '_blank','tag' => 'a','href' => ''.e(route('ecommerce.settings.shipping-label-template.preview')).'','icon' => 'ti ti-eye']); ?>
                    <?php echo e(trans('plugins/ecommerce::shipping-label-template.preview')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal.action','data' => ['type' => 'warning','id' => 'reset-template-to-default-modal','title' => trans('plugins/ecommerce::shipping-label-template.confirm_reset'),'submitButtonLabel' => trans('plugins/ecommerce::shipping-label-template.continue'),'submitButtonAttrs' => ['id' => 'reset-template-to-default-button', 'data-target' => route('ecommerce.settings.shipping-label-template.reset')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','id' => 'reset-template-to-default-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.confirm_reset')),'submit-button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.continue')),'submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['id' => 'reset-template-to-default-button', 'data-target' => route('ecommerce.settings.shipping-label-template.reset')])]); ?>
        <?php echo BaseHelper::clean(trans('plugins/ecommerce::shipping-label-template.confirm_message')); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipping-label-template/settings.blade.php ENDPATH**/ ?>