...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_posts','label' => 'Update existing posts','helperText' => 'Existing posts will be updated based on the slug or exact name. Posts that do not exist will be ignored.','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_posts','label' => 'Update existing posts','helper-text' => 'Existing posts will be updated based on the slug or exact name. Posts that do not exist will be ignored.','value' => '1']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/blog/resources/views/posts/partials/post-import-extra-fields.blade.php ENDPATH**/ ?>