...
<?php $component->withAttributes(['type' => 'warning','class' => 'approve-product-warning']); ?>
    <?php echo BaseHelper::clean(trans('plugins/ads::ads.adblock_warning')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ads/resources/views/partials/notification.blade.php ENDPATH**/ ?>