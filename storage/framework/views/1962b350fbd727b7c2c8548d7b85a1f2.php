...
<?php $component->withAttributes(['type' => 'info','class' => 'bg-white text-info']); ?>
                <div class="d-flex align-items-center">
                    <div>
                        <?php echo e(trans('plugins/blog::categories.table_view_info')); ?>

                        <a
                            href="<?php echo e(route('categories.index', ['as' => 'table'])); ?>"
                            class="text-decoration-underline"
                        >
                            <?php echo e(trans('plugins/blog::categories.manage_as_table')); ?>
...
<?php $component->withAttributes(['class' => 'tree-categories-body']); ?>
                    <div
                        ...
                        <?php if($updateTreeRoute): ?> data-update-url="<?php echo e(route($updateTreeRoute)); ?>" <?php endif; ?>
                    >
...
<?php echo $__env->make($layout ?? BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/blog/resources/views/categories/form-tree-category.blade.php ENDPATH**/ ?>