<script>
    window.addEventListener('load', function() {
        ...
        var currentCurrency = '<?php echo e(get_application_currency()->title); ?>';
        ...
        <?php if(session('ecommerce_customer_registered')): ?>
        fbq('track', 'CompleteRegistration', {
        ...
        <?php if(get_ecommerce_setting('facebook_pixel_debug_mode')): ?>
    ...
    <?php if($__pixelEvents ?? false): ?>
        <?php $__currentLoopData = $__pixelEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            window.fbqServerEvents['<?php echo e($event); ?>'] = true;
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
</script>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/facebook-pixel-script.blade.php ENDPATH**/ ?>