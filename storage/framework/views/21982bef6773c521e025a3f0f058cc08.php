<div class="tp-shop-widget mb-35 tp-sidebar-search">
    <div class="tp-sidebar-search-input">
        <input type="search" name="q" placeholder="<?php echo e(trans('plugins/ecommerce::ecommerce.search_1')); ?>" value="<?php echo e(BaseHelper::stringify(old('q', request()->query('q')))); ?>">
        <button type="submit">
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/filters/search.blade.php ENDPATH**/ ?>