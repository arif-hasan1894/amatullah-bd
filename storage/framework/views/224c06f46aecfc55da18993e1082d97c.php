...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'cbdd3a194c072fbc3f04e785bd9366eb::section','data' => ['title' => trans('core/setting::cronjob.name'),'description' => trans('core/setting::cronjob.description')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/setting::cronjob.name')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/setting::cronjob.description'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'warning','title' => trans('core/setting::cronjob.is_not_ready'),'icon' => 'ti ti-alert-triangle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/setting::cronjob.is_not_ready')),'icon' => 'ti ti-alert-triangle']); ?>
                 <?php $__env->slot('subtitle', null, []); ?> 
                    <?php echo e(trans('core/setting::cronjob.is_not_ready_description')); ?>
...
<?php endif; ?>
        <?php elseif(Carbon\Carbon::now()->diffInMinutes($lastRunAt) <= 10): ?>
            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'success','title' => trans('core/setting::cronjob.is_working'),'icon' => 'ti ti-circle-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/setting::cronjob.is_working')),'icon' => 'ti ti-circle-check']); ?>
                 <?php $__env->slot('subtitle', null, []); ?> 
...
<?php endif; ?>
        <?php else: ?>
            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'danger','title' => trans('core/setting::cronjob.is_not_working'),'icon' => 'ti ti-alert-circle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/setting::cronjob.is_not_working')),'icon' => 'ti ti-alert-circle']); ?>
                 <?php $__env->slot('subtitle', null, []); ?> 
                    <?php echo e(trans('core/setting::cronjob.is_not_working_description')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mt-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('core/setting::cronjob.what_is.title')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <div class="card-body">
                <p class="mb-3"><?php echo e(trans('core/setting::cronjob.what_is.description')); ?></p>
                <div class="text-muted">
                    <strong><?php echo e(trans('core/setting::cronjob.what_is.examples')); ?>:</strong>
                    <?php echo e(trans('core/setting::cronjob.what_is.features')); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('core/setting::cronjob.command.title')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
<?php unset($__attributesOriginal61297c2b6766060b621d6f9a17b28154); ?>
...
<?php endif; ?>
            <div class="card-body">
                <p class="text-muted mb-3"><?php echo e(trans('core/setting::cronjob.command.description')); ?></p>
                <div class="input-group">
                    <input
                        type="text"
                        id="command"
                        class="form-control font-monospace"
                        value="<?php echo e($command); ?>"
                        readonly
                    >
                    <button
                        ...
                        data-clipboard-message="<?php echo e(trans('core/setting::cronjob.setup.copied')); ?>"
                    >
...
<?php endif; ?>
                        <?php echo e(trans('core/setting::cronjob.copy_button')); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('core/setting::cronjob.setup.name')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
<?php unset($__attributesOriginal61297c2b6766060b621d6f9a17b28154); ?>
...
<?php endif; ?>
            <div class="card-body">
                <p class="text-muted mb-3"><?php echo e(trans('core/setting::cronjob.setup.choose_hosting')); ?></p>
                ...
                <div class="tab-content mt-3">
                    ...
                    <div class="tab-pane fade show active" id="cpanel-tab" role="tabpanel">
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = ['step1', 'step2', 'step3', 'step4', 'step5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <span class="badge bg-blue-lt"><?php echo e($index + 1); ?></span>
                                        </div>
                                        <div class="col">
                                            <?php echo BaseHelper::clean(trans("core/setting::cronjob.cpanel.{$step}")); ?>
                            ...
                            <?php $__currentLoopData = ['step1', 'step2', 'step3', 'step4', 'step5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <?php echo BaseHelper::clean(trans("core/setting::cronjob.plesk.{$step}")); ?>
                            ...
                            <?php $__currentLoopData = ['step1', 'step2', 'step3', 'step4', 'step5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <?php echo BaseHelper::clean(trans("core/setting::cronjob.directadmin.{$step}")); ?>
                            ...
                            <?php $__currentLoopData = ['step1', 'step2', 'step3', 'step4', 'step5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <?php echo BaseHelper::clean(trans("core/setting::cronjob.ssh.{$step}")); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                        <?php echo BaseHelper::clean(trans('core/setting::cronjob.need_help')); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/core/setting/resources/views/cronjob.blade.php ENDPATH**/ ?>