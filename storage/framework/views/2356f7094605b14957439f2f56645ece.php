                ...
                <?php if(count($products)): ?>
                    <?php $__currentLoopData = Cart::instance('cart')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(!empty($product)): ?>
                            <?php
                                $cartImage = $cartItem->options->image ?? $cartItem->options['image'] ?? null;
                                $productImage = $cartImage ?: ($product->image ?: $product->original_product->image);
                            ?>
                            <div class="ps-product--cart-mobile">
                                <div class="ps-product__thumbnail">
                                    <a href="<?php echo e($product->original_product->url); ?>">
                                        <img src="<?php echo e(RvMedia::getImageUrl($productImage, 'thumb', false, RvMedia::getDefaultImage())); ?>" alt="<?php echo e($product->original_product->name); ?>">
                                    </a>
                                </div>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/themes/amatullah/partials/cart.blade.php ENDPATH**/ ?>