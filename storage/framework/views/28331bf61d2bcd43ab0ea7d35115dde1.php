...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['class' => 'add-locale-form','url' => route('translations.locales'),'method' => 'post']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'add-locale-form','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('translations.locales')),'method' => 'post']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['label' => trans('plugins/translation::translation.locale'),'name' => 'locale','options' => ['' => trans('plugins/translation::translation.select_locale')] +
                                collect($locales)->map(fn($item, $key) => $item . ' - ' . $key)->all(),'searchable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/translation::translation.locale')),'name' => 'locale','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['' => trans('plugins/translation::translation.select_locale')] +
                                collect($locales)->map(fn($item, $key) => $item . ' - ' . $key)->all()),'searchable' => true]); ?>
...
<?php $component->withAttributes(['type' => 'submit','color' => 'primary']); ?>
                            <?php echo e(trans('plugins/translation::translation.add_new_locale')); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('plugins/translation::translation.locales')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <div class="table-responsive">
                    <table class="table card-table table-hover table-language">
                        <thead>
                            <tr>
                                <th class="text-start"><?php echo e(trans('plugins/translation::translation.name')); ?></th>
                                <th><?php echo e(trans('plugins/translation::translation.locale')); ?></th>
                                <th><?php echo e(trans('plugins/translation::translation.is_default')); ?></th>
                                <th class="text-end"><?php echo e(trans('plugins/translation::translation.actions')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__currentLoopData = $existingLocales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('plugins/translation::partials.locale-item', compact('item'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal.action','data' => ['type' => 'danger','class' => 'modal-confirm-delete','title' => trans('core/base::tables.confirm_delete'),'description' => trans('plugins/translation::translation.confirm_delete_message', ['lang_path' => lang_path()]),'submitButtonLabel' => trans('core/base::tables.delete'),'submitButtonAttrs' => ['class' => 'delete-crud-entry']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger','class' => 'modal-confirm-delete','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::tables.confirm_delete')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/translation::translation.confirm_delete_message', ['lang_path' => lang_path()])),'submit-button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::tables.delete')),'submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['class' => 'delete-crud-entry'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9376784f974ff66f3ff18195ab0a89c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9376784f974ff66f3ff18195ab0a89c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal.action','data' => ['class' => 'modal-confirm-import-locale','title' => trans('plugins/translation::translation.import_available_locale_confirmation'),'description' => BaseHelper::clean(
        ...
        ),'type' => 'info','submitButtonAttrs' => ['class' => 'button-confirm-import-locale'],'submitButtonLabel' => trans('plugins/translation::translation.download_locale')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::modal.action'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'modal-confirm-import-locale','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/translation::translation.import_available_locale_confirmation')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(BaseHelper::clean(
            trans('plugins/translation::translation.import_available_locale_confirmation_content', [
                'lang_path' => Html::tag('strong', lang_path())->toHtml(),
            ]),
        )),'type' => 'info','submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['class' => 'button-confirm-import-locale']),'submit-button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/translation::translation.download_locale'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9376784f974ff66f3ff18195ab0a89c5)): ?>
<?php $attributes = $__attributesOriginal9376784f974ff66f3ff18195ab0a89c5; ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/translation/resources/views/locales.blade.php ENDPATH**/ ?>