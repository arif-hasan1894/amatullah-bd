...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['class' => 'table-bordered']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.group')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.attribute')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.value')); ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                <?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.hide')); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.header.cell','data' => ['class' => 'text-center','style' => 'width: 40px;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.header.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center','style' => 'width: 40px;']); ?>
                <?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.sorting')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php $__currentLoopData = $groupedAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $groupData['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($groupData['group']->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($attribute->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php $component->withAttributes([]); ?>
                            <?php if($isDefaultLanguage): ?>
                                <?php if($attribute->type == 'text'): ?>
                                    <input class="form-control" type="text" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="<?php echo e($attributeValue); ?>" placeholder="<?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.enter_value')); ?>">
                                <?php elseif($attribute->type == 'textarea'): ?>
                                    <textarea class="form-control" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" placeholder="<?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.enter_value')); ?>"><?php echo e($attributeValue); ?></textarea>
                                <?php elseif($attribute->type == 'checkbox'): ?>
                                    <input class="form-check-input" type="checkbox" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="1" <?php if($attributeValue): echo 'checked'; endif; ?>>
                                <?php elseif($attribute->type == 'select'): ?>
                                    <select class="form-select" name="specification_attributes[<?php echo e($attribute->id); ?>][value]">
                                        <option value="">--</option>
                                        <?php if($attribute->hasIdBasedOptions()): ?>
                                            <?php $__currentLoopData = $attribute->getIdBasedOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($opt['id']); ?>" <?php if($opt['id'] === $attributeValue): echo 'selected'; endif; ?>><?php echo e($opt['value']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $attribute->options ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>" <?php if($value === $attributeValue): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                    ...
                                    <?php if($attribute->hasIdBasedOptions()): ?>
                                        <?php $__currentLoopData = $attribute->getIdBasedOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="<?php echo e($opt['id']); ?>" <?php if($opt['id'] === $attributeValue): echo 'checked'; endif; ?>>
                                                <span class="form-check-label"><?php echo e($opt['value']); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <?php $__currentLoopData = $attribute->options ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="<?php echo e($value); ?>" <?php if($value === $attributeValue): echo 'checked'; endif; ?>>
                            ...
                            <?php else: ?>
                                <?php if($attribute->type == 'text'): ?>
                                    <input class="form-control" type="text" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="<?php echo e($attributeValue); ?>" placeholder="<?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.enter_translation')); ?>">
                                <?php elseif($attribute->type == 'textarea'): ?>
                                    <textarea class="form-control" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" placeholder="<?php echo e(trans('plugins/ecommerce::product-specification.product.specification_table.enter_translation')); ?>"><?php echo e($attributeValue); ?></textarea>
                                <?php elseif($attribute->type == 'checkbox'): ?>
                                    <input class="form-check-input" type="checkbox" name="specification_attributes[<?php echo e($attribute->id); ?>][value]" value="1" <?php if($attributeValue): echo 'checked'; endif; ?>>
                                <?php elseif($attribute->type == 'select' || $attribute->type == 'radio'): ?>
                                    <?php
                                        $resolvedLabel = null;
                                    ...
                                    ?>
                                    <span class="form-control-plaintext text-muted"><?php echo e($resolvedLabel ?? '—'); ?></span>
                                <?php endif; ?>
                            <?php endif; ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <?php if($isDefaultLanguage): ?>
                                <input class="form-check-input" type="checkbox" name="specification_attributes[<?php echo e($attribute->id); ?>][hidden]" value="1" <?php if($data['isHidden']): echo 'checked'; endif; ?>>
                            <?php else: ?>
                                <?php if($data['isHidden']): ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <?php if($isDefaultLanguage): ?>
                                <input type="hidden" name="specification_attributes[<?php echo e($attribute->id); ?>][order]" value="<?php echo e($data['order']); ?>">
                                <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php endif; ?>
                            <?php else: ?>
                                <span class="text-muted"><?php echo e($data['order']); ?></span>
                            <?php endif; ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/specification-table/table.blade.php ENDPATH**/ ?>