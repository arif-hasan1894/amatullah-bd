    ...
    <div class="site-notice-body">
        <div class="site-notice__header">
            <div class="site-notice__header-left">
                ...
                <p class="site-notice__title" id="js-site-notice-title"><?php echo e($cardTitle); ?></p>
            </div>
            <button
                type="button"
                class="js-site-notice-essential site-notice__close"
                aria-label="<?php echo e(trans('plugins/cookie-consent::cookie-consent.essential_only_text')); ?>"
            >
        ...
        <div class="site-notice__content">
            <p class="site-notice__message">
                <?php echo BaseHelper::clean($cardMessage); ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/cookie-consent/resources/views/styles/card.blade.php ENDPATH**/ ?>