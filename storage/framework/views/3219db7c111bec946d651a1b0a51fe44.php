<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <?php echo $__env->make('plugins/ecommerce::shipments.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e(trans('plugins/ecommerce::shipping.shipping_label.name')); ?>
...
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('ecommerce.shipments.print', $shipment)),'target' => '_blank','icon' => 'ti ti-printer']); ?>
                            <?php echo e(trans('plugins/ecommerce::shipping.shipping_label.print')); ?>
...
<?php endif; ?>
                ...
                <?php echo apply_filters('shipment_buttons_detail', null, $shipment); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipments/edit.blade.php ENDPATH**/ ?>