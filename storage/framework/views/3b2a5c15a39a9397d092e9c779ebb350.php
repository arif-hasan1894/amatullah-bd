<?php if($products->isNotEmpty()): ?>
    ...
    <div class="bb-quick-search-view-all">
        <a href="#" onclick="event.preventDefault(); this.closest('.bb-form-quick-search').submit();"><?php echo e(trans('plugins/ecommerce::ecommerce.view_all_results')); ?></a>
    </div>
<?php else: ?>
    <div class="bb-quick-search-empty">
        <?php echo e(trans('plugins/ecommerce::ecommerce.no_results_found')); ?>

    </div>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/ajax-search-results.blade.php ENDPATH**/ ?>