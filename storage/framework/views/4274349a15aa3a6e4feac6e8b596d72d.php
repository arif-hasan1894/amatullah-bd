<?php if($shipment->histories->isNotEmpty()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/ecommerce::shipping.history')); ?>
...
<?php $component->withAttributes([]); ?>
            <ul class="steps steps-vertical border-0 p-0 m-0" id="order-history-wrapper">
                <?php $__currentLoopData = $shipment->histories->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="<?php echo \Illuminate\Support\Arr::toCssClasses(['step-item', 'user-action' => $history->user_id]); ?>">
                        <div class="h4 m-0">
                            <?php echo BaseHelper::clean(OrderHelper::processHistoryVariables($history)); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipments/histories.blade.php ENDPATH**/ ?>