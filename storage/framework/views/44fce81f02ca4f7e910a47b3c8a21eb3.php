...
unset($__errorArgs, $__bag); ?>">
                        <div class="form-input-wrapper">
                            <input
                                ...
                                <?php if(in_array('email', $enabledMandatoryFields)): echo 'required'; endif; ?>
                            >
                            <label for="address_email"><?php echo e(__('Email')); ?><?php if(!in_array('email', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                        </div>
                        ...
                        <div class="phone-input-wrapper">
                            <?php if($phoneCountryCodeEnabled): ?>
                                <input
                                    ...
                                    <?php if(in_array('phone', $enabledMandatoryFields)): echo 'required'; endif; ?>
                                >
                                <input
                                    type="hidden"
                                    name="address[phone]"
                            ...
                            <?php else: ?>
                                ...
                                >
                            <?php endif; ?>
                            <label for="address_phone"><?php echo e(__('Phone')); ?><?php if(!in_array('phone', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                        </div>
...
unset($__errorArgs, $__bag); ?>">
                <div class="select--arrow form-input-wrapper">
                    <select
                        ...
                        data-type="country"
                        <?php if(in_array('country', $enabledMandatoryFields)): echo 'required'; endif; ?>
                    >
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <label for="address_country"><?php echo e(__('Country')); ?><?php if(!in_array('country', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                </div>
                        ...
                        <?php if(EcommerceHelper::loadCountriesStatesCitiesFromPluginLocation()): ?>
                            <div class="select--arrow form-input-wrapper">
                                <select
                                    ...
                                    <?php if(in_array('state', $enabledMandatoryFields)): echo 'required'; endif; ?>
                                >
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                <label for="address_state"><?php echo e(__('State')); ?><?php if(!in_array('state', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                            </div>
                        <?php else: ?>
                            <div class="form-input-wrapper">
                                <input
                        ...
                        <?php if(EcommerceHelper::useCityFieldAsTextField()): ?>
                            <div class="form-input-wrapper">
                                <input
                                    ...
                                    <?php if(in_array('city', $enabledMandatoryFields)): echo 'required'; endif; ?>
                                >
                                <label for="address_city"><?php echo e(__('City')); ?><?php if(!in_array('city', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                            </div>
                        <?php else: ?>
                            <div class="select--arrow form-input-wrapper">
                                <select
...
unset($__errorArgs, $__bag); ?>">
                <div class="form-input-wrapper">
                    <input
                        ...
                        <?php if(in_array('address', $enabledMandatoryFields)): echo 'required'; endif; ?>
                    >
                    <label for="address_address"><?php echo e(__('Address')); ?><?php if(!in_array('address', $enabledMandatoryFields)): ?> <small class="text-muted fw-normal">(<?php echo e(trans('plugins/ecommerce::ecommerce.optional')); ?>)</small><?php endif; ?></label>
                </div>
...
<?php if (! $__env->hasRenderedOnce('97e151c3-3818-49b7-b6bc-d0768d959f76')): $__env->markAsRenderedOnce('97e151c3-3818-49b7-b6bc-d0768d959f76'); ?>
    <?php echo $__env->make('core/base::forms.fields.phone-number-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/orders/partials/address-form.blade.php ENDPATH**/ ?>