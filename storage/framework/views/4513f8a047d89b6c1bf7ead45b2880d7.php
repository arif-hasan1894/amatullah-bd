...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(trans('plugins/marketplace::marketplace.vendor_information')); ?>
...
<?php $component->withAttributes(['class' => 'p-0']); ?>
                    <div class="text-center p-3">
                        <div class="mb-2">
                            <img
                                src="<?php echo e($vendor->avatar_url ?: RvMedia::getDefaultImage()); ?>"
                                alt="<?php echo e($vendor->name); ?>"
                                class="avatar avatar-rounded avatar-xl"
                            />
                        </div>

                        <h3 class="m-0"><?php echo e($vendor->name); ?></h3>
                        <p class="text-muted"><?php echo e($vendor->email); ?></p>
...
<?php endif; ?>
                            ...
                            <?php if($vendor->vendor_verified_at): ?>
                                <span class="badge bg-green text-green-fg">
                                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                    <?php echo e(trans('plugins/marketplace::marketplace.vendor_verified')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                    <?php echo e(trans('plugins/marketplace::marketplace.vendor_not_verified')); ?>
                    ...
                    <div class="p-3">
                        <dl class="row">
                            ...
                            <dd class="col-auto">
                                <?php echo BaseHelper::clean($vendor->status->toHtml()); ?>
                        ...
                        <?php if($vendor->dob): ?>
                            <dl class="row">
                                ...
                                <dd class="col-auto"><?php echo e(BaseHelper::formatDate($vendor->dob, 'Y-m-d')); ?></dd>
                            </dl>
                        <?php endif; ?>

                        <?php if($vendor->created_at): ?>
                            <dl class="row">
                                <dt class="col"><?php echo e(trans('core/base::tables.created_at')); ?></dt>
                                <dd class="col-auto"><?php echo e(BaseHelper::formatDate($vendor->created_at, 'Y-m-d H:i')); ?></dd>
                            </dl>
                        <?php endif; ?>

                        <?php if($vendor->vendor_verified_at): ?>
                            <dl class="row">
                                <dt class="col"><?php echo e(trans('plugins/marketplace::marketplace.vendor_verified_at')); ?></dt>
                                <dd class="col-auto"><?php echo e(BaseHelper::formatDate($vendor->vendor_verified_at, 'Y-m-d H:i')); ?></dd>
                            </dl>
                        <?php endif; ?>
                    ...
                    <div class="p-3">
                        <a href="<?php echo e(route('customers.edit', $vendor->id)); ?>" class="btn btn-primary w-100">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php $component->withAttributes(['class' => 'p-0']); ?>
                        <div class="p-3 text-center">
                            ...
                            <h3 class="m-0">
                                <a href="<?php echo e(route('marketplace.store.edit', $store->id)); ?>" target="_blank">
...
<?php endif; ?>
                            ...
                            <?php if($store->email): ?>
                                <p class="text-muted mb-1"><?php echo e($store->email); ?></p>
                            <?php endif; ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                    <?php echo e(trans('plugins/marketplace::store.verified')); ?>

                                </span>
                            <?php endif; ?>
                        </div>

                        <?php if($store->address || $store->city || $store->state || $store->country): ?>
                            <div class="hr my-2"></div>
                            <div class="p-3">
                                <strong><?php echo e(trans('plugins/marketplace::store.forms.address')); ?></strong>
                                <p class="text-muted mb-0">
                                    <?php echo e($store->address); ?>

                                    <?php if($store->city): ?>, <?php echo e($store->city); ?><?php endif; ?>
                                    <?php if($store->state): ?>, <?php echo e($store->state); ?><?php endif; ?>
                                    <?php if($store->country_name): ?>, <?php echo e($store->country_name); ?><?php endif; ?>
                                    <?php if($store->zip_code): ?> <?php echo e($store->zip_code); ?><?php endif; ?>
                                </p>
                            </div>
                        <?php endif; ?>

                        <?php if($store->certificate_file || $store->government_id_file): ?>
                            <div class="hr my-2"></div>
                            <div class="p-3">
                                <strong><?php echo e(trans('plugins/marketplace::marketplace.documents')); ?></strong>
                                <div class="mt-2">
                                    <?php if($store->certificate_file && Storage::disk('local')->exists($store->certificate_file)): ?>
                                        <a href="<?php echo e(route('marketplace.vendors.download-certificate', $vendor->id)); ?>"
                                           class="btn btn-sm btn-outline-primary w-100 mb-2"
                                           target="_blank">
                                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-file-certificate'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                            <?php echo e(trans('plugins/marketplace::marketplace.view_certificate')); ?>

                                        </a>
                                    <?php endif; ?>

                                    <?php if($store->government_id_file && Storage::disk('local')->exists($store->government_id_file)): ?>
                                        <a href="<?php echo e(route('marketplace.vendors.download-government-id', $vendor->id)); ?>"
                                           class="btn btn-sm btn-outline-primary w-100"
                                           target="_blank">
                                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-id'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                            <?php echo e(trans('plugins/marketplace::marketplace.view_government_id')); ?>
                        ...
                        <?php if($store->tax_id): ?>
                            ...
                            <div class="p-3">
                                <dl class="row mb-0">
                                    <dt class="col"><?php echo e(trans('plugins/marketplace::store.tax_id')); ?></dt>
                                    <dd class="col-auto"><?php echo e($store->tax_id); ?></dd>
                                </dl>
                            </div>
                        <?php endif; ?>
                     <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
            ...
            <?php if($vendor->addresses->count() > 0): ?>
                <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mt-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card'); ?>
...
<?php $component->withAttributes(['class' => 'p-0']); ?>
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $vendor->addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.store_products')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(number_format($storeProducts)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.store_orders')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(number_format($storeOrders)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.total_revenue')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(format_price($totalRevenue)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.total_earnings')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(format_price($totalEarnings)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.withdrawals')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(format_price($totalWithdrawals)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.pending_withdrawals')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(format_price($pendingWithdrawals)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="d-flex align-items-center">
                                <div class="subheader"><?php echo e(trans('plugins/marketplace::marketplace.balance')); ?></div>
                            </div>
                            <div class="h1 mb-0"><?php echo e(format_price($balance)); ?></div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
<?php $attributes = $__attributesOriginal4fdb92edf089f19cd17d37829580c9a6; ?>
...
<?php endif; ?>
            ...
            <?php if($store && $store->products()->count() > 0): ?>
                <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e(trans('plugins/marketplace::marketplace.recent_products')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $store->products()->latest()->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes([]); ?>
                                        <div class="d-flex align-items-center">
                                            <img
                                                src="<?php echo e(RvMedia::getImageUrl($product->image, 'thumb', false, RvMedia::getDefaultImage())); ?>"
                                                alt="<?php echo e($product->name); ?>"
                                                class="me-2 rounded"
                                                style="width: 40px; height: 40px; object-fit: cover;"
                                            />
                                            <div>
                                                <a href="<?php echo e(route('products.edit', $product->id)); ?>" target="_blank">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e($product->created_at ? BaseHelper::formatDate($product->created_at, 'Y-m-d') : '—'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="text-decoration-none" target="_blank">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $vendor->orders()->latest()->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal6776c17865a79e242405889703595892 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6776c17865a79e242405889703595892 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.row','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.row'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php echo e($order->created_at ? BaseHelper::formatDate($order->created_at, 'Y-m-d H:i') : '—'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e(trans('plugins/ecommerce::customer.recent_reviews')); ?> (<?php echo e($vendor->reviews->count()); ?>)
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = $vendor->reviews()->latest()->limit(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/vendors/view.blade.php ENDPATH**/ ?>