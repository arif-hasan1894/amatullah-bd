<?php if(EcommerceHelper::hasAnyProductFilters()): ?>
    ...
    <div class="bb-shop-sidebar">
        <form action="<?php echo e(URL::current()); ?>" data-action="<?php echo e(route('public.products')); ?>" method="GET" class="bb-product-form-filter">
            ...
            <?php if(EcommerceHelper::isEnabledFilterProductsByLabels()): ?>
                <?php echo $__env->make(EcommerceHelper::viewPath('includes.filters.labels'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
            ...
            <?php echo $__env->make(EcommerceHelper::viewPath('includes.filters.discounted-only'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <?php if(EcommerceHelper::isEnabledFilterProductsByRating()): ?>
                <?php echo $__env->make(EcommerceHelper::viewPath('includes.filters.rating'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/filters.blade.php ENDPATH**/ ?>