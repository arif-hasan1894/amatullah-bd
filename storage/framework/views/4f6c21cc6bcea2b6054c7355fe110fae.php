        ...
        <div class="ps-layout__right">
            <div class="ps-block--shop-features">
                <div class="ps-block__header">
                    <h1 class="h1"><?php echo e($tag->name); ?></h1>
                </div>
                <?php if($tag->content): ?>
                    <div class="ps-block__content">
                        <div class="ps-section__content">
                            <?php echo \Botble\Shortcode\Facades\Shortcode::compile($tag->content, true)->toHtml(); ?>

                        </div>
                    </div>
                <?php elseif($tag->description): ?>
                    <div class="ps-block__content">
                        <div class="ps-section__content">
                            <?php echo BaseHelper::clean($tag->description); ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/themes/amatullah/views/ecommerce/product-tag.blade.php ENDPATH**/ ?>