...
<?php $component->withAttributes(['type' => 'warning']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(trans('plugins/ecommerce::shipping.shipment_canceled')); ?>

         <?php $__env->endSlot(); ?>

        <?php echo e(trans('plugins/ecommerce::shipping.at')); ?>

        <i><?php echo e(BaseHelper::formatDate($shipment->updated_at, 'H:i d/m/Y')); ?></i>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipments/notification.blade.php ENDPATH**/ ?>