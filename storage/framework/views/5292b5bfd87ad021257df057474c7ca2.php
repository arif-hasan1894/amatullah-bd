...
<?php echo apply_filters('data_synchronize_import_page_before', null, $importer); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['method' => 'post','url' => $importer->getUploadUrl(),'dataValidateUrl' => $importer->getValidateUrl(),'dataImportUrl' => $importer->getImportUrl(),'dataBbToggle' => 'import-form','dataAcceptedFiles' => $acceptedFiles,'dataUploadingMessage' => trans('packages/data-synchronize::data-synchronize.import.uploading_message'),'dataValidateFailedMessage' => trans('packages/data-synchronize::data-synchronize.import.validating_failed_message'),'class' => 'data-synchronize-import-form']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['method' => 'post','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importer->getUploadUrl()),'data-validate-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importer->getValidateUrl()),'data-import-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importer->getImportUrl()),'data-bb-toggle' => 'import-form','data-accepted-files' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($acceptedFiles),'data-uploading-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/data-synchronize::data-synchronize.import.uploading_message')),'data-validate-failed-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/data-synchronize::data-synchronize.import.validating_failed_message')),'class' => 'data-synchronize-import-form']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($importer->getHeading()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'info','dataUrl' => $importer->getExportUrl()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'info','data-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importer->getExportUrl())]); ?>
...
<?php endif; ?>
            ...
            <?php echo apply_filters('data_synchronize_import_form_before', null, $importer); ?>


            <?php echo $__env->yieldContent('import_extra_form_before'); ?>

            <div class="mb-3">
                <div class="dropzone">
                    <div class="dz-message">
                        <?php echo e(trans('packages/data-synchronize::data-synchronize.import.form.dropzone_message')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.helper-text','data' => ['class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mt-1']); ?>
                    <?php echo e(trans('packages/data-synchronize::data-synchronize.import.form.allowed_extensions', ['extensions' => Arr::join($importer->getFileExtensions(), ', ')])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.label','data' => ['for' => 'chunk-size']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'chunk-size']); ?><?php echo e(trans('packages/data-synchronize::data-synchronize.import.form.chunk_size')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['type' => 'number','class' => 'form-control','id' => 'chunk-size','name' => 'chunk_size','value' => ''.e($importer->chunkSize()).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'number','class' => 'form-control','id' => 'chunk-size','name' => 'chunk_size','value' => ''.e($importer->chunkSize()).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('packages/data-synchronize::data-synchronize.import.form.chunk_size_helper')); ?>
...
<?php endif; ?>
            ...
            <?php echo apply_filters('data_synchronize_import_form_after', null, $importer); ?>


            <?php echo $__env->yieldContent('import_extra_form_after'); ?>
...
<?php if(isset($importer) && $importer instanceof \Botble\Page\Importers\PageImporter): ?>
    <?php echo $__env->make('packages/page::pages.partials.page-import-extra-fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>


<?php if(isset($importer) && $importer instanceof \Botble\LanguageAdvanced\Importers\ModelTranslationImporter && $importer->isForModel(\Botble\Page\Models\Page::class)): ?>
    <?php echo $__env->make('packages/page::pages.partials.page-translation-import-extra-fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>



<?php if(isset($importer) && $importer instanceof \Botble\LanguageAdvanced\Importers\ModelTranslationImporter && $importer->isForModel(\Botble\Ecommerce\Models\Product::class)): ?>
    <?php echo $__env->make('plugins/ecommerce::products.partials.product-translation-import-extra-fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>



<?php if(isset($importer) && $importer instanceof \Botble\LanguageAdvanced\Importers\ModelTranslationImporter && $importer->isForModel(\Botble\Ecommerce\Models\ProductCategory::class)): ?>
    <?php echo $__env->make('plugins/ecommerce::product-categories.partials.product-category-translation-import-extra-fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'submit','color' => 'primary','disabled' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','color' => 'primary','disabled' => true]); ?>
                <?php echo e(trans('packages/data-synchronize::data-synchronize.import.form.import_button')); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['class' => 'mt-3','type' => 'danger','style' => 'display: none','dataBbToggle' => 'import-errors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-3','type' => 'danger','style' => 'display: none','data-bb-toggle' => 'import-errors']); ?>
        <ul></ul>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c)): ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mt-3 bg-warning-lt','dataBbToggle' => 'import-failures','style' => 'display: none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-3 bg-warning-lt','data-bb-toggle' => 'import-failures','style' => 'display: none']); ?>
        <?php if (isset($component)) { $__componentOriginalf7ec4b8ef3fc6db54b9665bd653222c4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf7ec4b8ef3fc6db54b9665bd653222c4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.header.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card.header'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('packages/data-synchronize::data-synchronize.import.failures.title')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('packages/data-synchronize::data-synchronize.import.failures.attribute')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('packages/data-synchronize::data-synchronize.import.failures.errors')); ?>
...
<?php echo apply_filters('data_synchronize_import_page_after', null, $importer); ?>


<?php if($importer->getExportUrl()): ?>
    <?php if (isset($component)) { $__componentOriginald83dae5750a07af1a413e54a0071b325 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald83dae5750a07af1a413e54a0071b325 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['method' => 'POST','url' => $importer->getExportUrl(),'dataBbToggle' => 'export-data','dataSuccessMessage' => trans('packages/data-synchronize::data-synchronize.export.success_message'),'dataErrorMessage' => trans('packages/data-synchronize::data-synchronize.export.error_message')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'POST','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importer->getExportUrl()),'data-bb-toggle' => 'export-data','data-success-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/data-synchronize::data-synchronize.export.success_message')),'data-error-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/data-synchronize::data-synchronize.export.error_message'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald83dae5750a07af1a413e54a0071b325)): ?>
<?php $attributes = $__attributesOriginald83dae5750a07af1a413e54a0071b325; ?>
...
<?php if($importer->getExamples()): ?>
    <?php echo $__env->make('packages/data-synchronize::partials.example', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>

<?php echo $__env->renderWhen($importer->showRulesCheatSheet(), 'packages/data-synchronize::partials.rules', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::custom-template','data' => ['id' => 'data-synchronize-import-preview-template']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'data-synchronize-import-preview-template']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['style' => 'height: 2rem; width: 2rem']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo apply_filters('data_synchronize_import_page_footer', null, $importer); ?>

<?php /**PATH /var/www/dev.amatullah.bd/vendor/botble/data-synchronize/src/Providers/../../resources/views/partials/importer.blade.php ENDPATH**/ ?>