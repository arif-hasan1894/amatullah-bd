...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/ecommerce::shipping.shipment_information')); ?>
...
<?php $component->withAttributes([]); ?>
        <dl class="d-flex flex-column gap-3">
            <div class="row">
                <dt class="col">
                    <?php echo e(trans('plugins/ecommerce::shipping.order_number')); ?>

                </dt>
                <dd class="col-auto">
                    <?php if($orderEditRouteName): ?>
                        <a href="<?php echo e(route($orderEditRouteName, $shipment->order->id)); ?>" target="_blank">
                            <?php echo e($shipment->order->code); ?>
...
<?php endif; ?>
            ...
            <div class="row">
                ...
                <dd class="col-auto">
                    <?php echo e(OrderHelper::getShippingMethod($shipment->order->shipping_method)); ?>

                    <?php if($shipment->order->shipping_option): ?>
            ...
            <div class="row">
                <dt class="col">
                    <?php echo e(trans('plugins/ecommerce::shipping.shipping_fee')); ?>

                </dt>
                <dd class="col-auto">
                    <?php echo e(format_price($shipment->price)); ?>
            ...
            <?php if((float) $shipment->cod_amount): ?>
                ...
                <div class="row">
                    <dt class="col">
                        <?php echo e(trans('plugins/ecommerce::shipping.cod_status')); ?>

                    </dt>
                    <dd class="col-auto">
                        <?php echo BaseHelper::clean($shipment->cod_status->toHtml()); ?>

                    </dd>
                    <?php if((float) $shipment->cod_amount && !$shipment->isCancelled): ?>
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#update-shipping-cod-status-modal" class="fw-semibold d-inline-block small mt-n1">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-pencil','size' => 'sm'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                            <?php echo e(trans('plugins/ecommerce::shipping.update_cod_status')); ?>
            ...
            <div class="row">
                <dt class="col">
                    <?php echo e(trans('plugins/ecommerce::shipping.shipping_status')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/ecommerce::shipping.customer_information')); ?>
...
<?php unset($__componentOriginalc107e2f90dff5eb05519f33918d2c807); ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/shipments/information.blade.php ENDPATH**/ ?>