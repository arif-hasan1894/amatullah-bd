<div class="table-actions">
    ...
    <?php if(!empty($edit)): ?>
        <?php if(Auth::guard()->user()->hasPermission($edit)): ?>
            <a
                class="btn btn-icon btn-sm btn-primary"
                data-bs-toggle="tooltip"
                data-bs-original-title="<?php echo e(trans('core/base::tables.edit')); ?>"
                href="<?php echo e(route($edit, $item->id)); ?>"
            >
...
<?php endif; ?>
    ...
    <?php if(!empty($delete)): ?>
        <?php if(Auth::guard()->user()->hasPermission($delete)): ?>
            <a
                class="btn btn-icon btn-sm btn-danger deleteDialog"
                data-bs-toggle="tooltip"
                data-section="<?php echo e(route($delete, $item->id)); ?>"
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/table/resources/views/partials/actions.blade.php ENDPATH**/ ?>