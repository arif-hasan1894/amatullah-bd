...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.on-off.checkbox','data' => ['label' => trans('plugins/ecommerce::products.digital_attachments.generate_license_code_after_purchasing_product'),'name' => 'generate_license_code','checked' => old('generate_license_code', $product ? $product->generate_license_code : 0),'dataBbToggle' => 'collapse','dataBbTarget' => '#license-code-options']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.digital_attachments.generate_license_code_after_purchasing_product')),'name' => 'generate_license_code','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('generate_license_code', $product ? $product->generate_license_code : 0)),'data-bb-toggle' => 'collapse','data-bb-target' => '#license-code-options']); ?>
...
<?php endif; ?>
        ...
        <div class="collapse <?php if(old('generate_license_code', $product ? $product->generate_license_code : 0)): ?> show <?php endif; ?>" id="license-code-options">
...
<?php $component->withAttributes(['id' => 'license-codes-table-body']); ?>
                        <?php if($product): ?>
                            <?php $__currentLoopData = $product->licenseCodes->filter(fn($code) => $code->isAvailable()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licenseCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('707c0737-a91c-4c12-b3e0-1eee0269996e')): $__env->markAsRenderedOnce('707c0737-a91c-4c12-b3e0-1eee0269996e');
$__env->startPush('footer'); ?>
        ...
        <?php if(EcommerceHelper::isEnabledLicenseCodesForDigitalProducts()): ?>
            <?php echo $__env->make('plugins/ecommerce::products.partials.license-code-template', ['isVariation' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
    <?php $__env->stopPush(); endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/themes/vendor-dashboard/products/partials/digital-attachments.blade.php ENDPATH**/ ?>