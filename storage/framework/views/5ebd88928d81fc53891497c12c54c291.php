<div class="table-wrapper">
    <?php if(session()->has('plainTextToken')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'success','title' => trans('packages/api::sanctum-token.generated_message')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('packages/api::sanctum-token.generated_message'))]); ?>
            <div class="d-flex align-items-center gap-1 mt-2">
                <code><?php echo e(session('plainTextToken')); ?></code>

                <a
                    href="javascript:void(0);"
                    data-bb-toggle="clipboard"
                    data-clipboard-action="copy"
                    data-clipboard-text="<?php echo e(session('plainTextToken')); ?>"
                    data-clipboard-message="<?php echo e(trans('core/table::table.copied')); ?>"
                    data-bs-toggle="tooltip"
                    title="<?php echo e(trans('core/table::table.copy')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::dropdown.index','data' => ['type' => 'button','label' => trans('core/table::table.bulk_actions')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="table-search-input">
                        <label><input type="search" class="form-control input-sm" placeholder="<?php echo e(trans('core/table::table.search')); ?>" style="min-width: 120px"></label>
                    </div>
                </div>
                    ...
                    <?php $__currentLoopData = $table->getDefaultButtons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defaultButton): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(is_string($defaultButton)): ?>
                            <?php switch($defaultButton):
                                case ('reload'): ?>
                                    <button class="btn item-action" data-bb-toggle="dt-buttons" data-bb-target=".buttons-reload" tabindex="0" aria-controls="<?php echo e($table->getOption('id')); ?>" type="button" aria-haspopup="dialog" aria-expanded="false">
                                            <span>
                                                <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php $component = $__componentOriginal73995948b3bd877b76251b40caf28170; ?>
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?> <?php echo e(trans('core/base::tables.reload')); ?>
                                ...
                                <?php case ('export'): ?>
                                    <div class="dropdown">
                                        <button class="btn buttons-collection dropdown-toggle buttons-export" data-bs-toggle="dropdown" tabindex="0" aria-controls="<?php echo e($table->getOption('id')); ?>" type="button" aria-haspopup="dialog" aria-expanded="false">
                                                <span>
                                                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/dev.amatullah.bd/vendor/botble/api/resources/views/table.blade.php ENDPATH**/ ?>