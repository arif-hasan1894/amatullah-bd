...
<?php if($showCurrencySelector): ?>
    <div class="d-flex align-items-center gap-2 mt-3 mb-3 mx-3">
        <label for="currency_code" class="form-label mb-0 text-nowrap"><?php echo e(trans('plugins/ecommerce::products.form.currency')); ?>:</label>
        <select name="currency_code" id="currency_code" class="form-select form-select-sm product-currency-selector" style="width: auto; min-width: 120px;">
            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($currency->title); ?>" data-symbol="<?php echo e($currency->symbol); ?>" <?php if($productCurrencyCode === $currency->title): echo 'selected'; endif; ?>>
                    <?php echo e($currency->title); ?> (<?php echo e($currency->symbol); ?>)
                </option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <small class="text-muted d-none d-md-inline"><?php echo e(trans('plugins/ecommerce::products.form.currency_for_variations_hint')); ?></small>
    </div>
<?php endif; ?>

<div id="product-variations-wrapper" data-clear-filters="<?php echo e(trans('plugins/ecommerce::products.clear_filters')); ?>">
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/configurable.blade.php ENDPATH**/ ?>