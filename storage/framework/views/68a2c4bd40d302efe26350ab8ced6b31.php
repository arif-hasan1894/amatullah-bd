<div class="bg-light py-2">
    <p class="font-weight-bold mb-0"><?php echo e(trans('plugins/ecommerce::order.products_label')); ?></p>
</div>
...
<div class="checkout-products-marketplace shipping-method-wrapper">
    <?php $__currentLoopData = $groupedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grouped): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-3 bg-light mb-3">
            <?php if(MarketplaceHelper::getSetting('show_vendor_info_at_checkout', true)): ?>
                    ...
                    <?php if($store->id && EcommerceHelper::isReviewEnabled()): ?>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="small text-muted">
                                ...
                                <?php else: ?>
                                    (<?php echo e(trans('plugins/ecommerce::review.count_reviews', ['count' => number_format($reviewsCount)])); ?>)
                                <?php endif; ?>
                            </span>
                        </div>
                    <?php endif; ?>
            ...
            <?php echo apply_filters('marketplace_checkout_after_store_products', null, $grouped['products'], $store); ?>


            <?php if($isAvailableShipping && MarketplaceHelper::isChargeShippingPerVendor()): ?>
                <div class="shipping-method-wrapper py-3" style="<?php echo \Illuminate\Support\Arr::toCssStyles(['display: none' => (bool) get_ecommerce_setting('disable_shipping_options', false)]) ?>">
                    <?php if(!empty($shipping)): ?>
                        <div class="payment-checkout-form">
                            <h6><?php echo e(trans('plugins/ecommerce::shipping.shipping_method')); ?>:</h6>
                    ...
                    <?php else: ?>
                        <p><?php echo e(trans('plugins/ecommerce::shipping.no_shipping_methods_available')); ?></p>
                    <?php endif; ?>
            ...
            <?php if(count($groupedProducts) > 1 && MarketplaceHelper::getSetting('display_order_total_info_for_each_store', false)): ?>
                <div class="p-3">
                    <div class="row">
                        <div class="col-6">
                            <p><?php echo e(trans('plugins/ecommerce::order.sub_amount')); ?>:</p>
                        </div>
                    ...
                    <?php if(EcommerceHelper::isTaxEnabled()): ?>
                        <div class="row">
                            <div class="col-6">
                                <p><?php echo e(trans('plugins/ecommerce::order.tax')); ?>:</p>
                            </div>
                            <div class="col-6 text-end">
                    ...
                    <?php if($couponDiscountAmount): ?>
                        <div class="row">
                            <div class="col-6">
                                <p><?php echo e(trans('plugins/ecommerce::order.discount')); ?>:</p>
                            </div>
                            <div class="col-6 text-end">
                    ...
                    <?php if($isAvailableShipping && MarketplaceHelper::isChargeShippingPerVendor()): ?>
                        <div class="row">
                            <div class="col-6">
                                <p><?php echo e(trans('plugins/ecommerce::order.shipping_fee')); ?>:</p>
                            </div>
                            <div class="col-6 text-end">
                                <p class="price-text">
                                    <?php if(Arr::get($shippingCurrent, 'price') && $isFreeShipping): ?>
                                        ...
                                        <span class="font-weight-bold"><?php echo e(trans('plugins/ecommerce::order.free_shipping')); ?></span>
                                    <?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <p><?php echo e(trans('plugins/ecommerce::order.total')); ?>:</p>
                        </div>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/orders/checkout/products.blade.php ENDPATH**/ ?>