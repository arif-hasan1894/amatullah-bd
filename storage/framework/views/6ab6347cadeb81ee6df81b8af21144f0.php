<div class="row">
    <?php $__currentLoopData = $productAttributeSets->sortBy('order')->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeSet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.label','data' => ['for' => 'attribute-'.e($attributeSet->slug).'','class' => 'required']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'attribute-'.e($attributeSet->slug).'','class' => 'required']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['name' => 'attribute_sets['.e($attributeSet->id).']','value' => Arr::first(array_keys($selected)),'options' => $selected,'dataId' => $attributeSet->id,'class' => 'select-attributes']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'attribute_sets['.e($attributeSet->id).']','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Arr::first(array_keys($selected))),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selected),'data-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributeSet->id),'class' => 'select-attributes']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/product-attribute-sets.blade.php ENDPATH**/ ?>