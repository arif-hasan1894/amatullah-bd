<script>
    window.addEventListener('load', function() {
         ...
         */
        var gtmUseGtag = <?php echo json_encode(app(\Botble\Ecommerce\AdsTracking\GoogleTagManager::class)->shouldUseGtag(), 15, 512) ?>;
        ...
        <?php if(request()->routeIs('public.products') && request('q')): ?>
        (function() {
            var productItems = document.querySelectorAll('.product-item, .product-card, [data-product-id]');
            pushEvent('search', {
                search_term: <?php echo json_encode(BaseHelper::stringify(request('q')), 15, 512) ?>,
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/gtm-script.blade.php ENDPATH**/ ?>