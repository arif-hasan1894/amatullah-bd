...
<?php $component->withAttributes([]); ?>
        <h4 class="card-title"><?php echo e(trans('plugins/marketplace::marketplace.reports.sale_commissions')); ?></h4>
...
<?php $component->withAttributes([]); ?>
        <div class="row">
            ...
            <div class="col-md-4">
                <?php if($count['revenues']->isNotEmpty()): ?>
...
<?php endif; ?>
                            <strong><?php echo e(format_price($salesReport['totalFee'])); ?></strong>
...
<?php if(request()->ajax()): ?>
    <?php echo $__env->make('plugins/marketplace::reports.widgets.chart-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php else: ?>
    <?php $__env->startPush('footer'); ?>
        <?php echo $__env->make('plugins/marketplace::reports.widgets.chart-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/reports/widgets/sale-commissions.blade.php ENDPATH**/ ?>