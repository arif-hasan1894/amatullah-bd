...
<head>
    ...
    <style>
        :root {
            ...
            --footer-background-color: <?php echo e(theme_option('footer_background_color', '#ffffff')); ?>;
            --footer-text-color: <?php echo e(theme_option('footer_text_color', '#666')); ?>;
            --footer-text-link-color: <?php echo e(theme_option('footer_text_link_color', '#666')); ?>;
            --footer-text-link-hover-color: <?php echo e(theme_option('footer_text_link_hover_color', '#fcb800')); ?>;
            --footer-border-color: <?php echo e(theme_option('footer_border_color', '#e1e1e1')); ?>;
            --footer-heading-color: <?php echo e(theme_option('footer_heading_color', '#000')); ?>;
        }
    </style>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/themes/amatullah/partials/header-meta.blade.php ENDPATH**/ ?>