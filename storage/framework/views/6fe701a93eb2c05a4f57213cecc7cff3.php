...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('plugins/location::bulk-import.import_available_data')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['url' => route('location.bulk-import.import-location-data'),'method' => 'post','dataBbToggle' => 'import-available-data','dataEmptySelectionMessage' => trans('plugins/location::bulk-import.choose_country')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('location.bulk-import.import-location-data')),'method' => 'post','data-bb-toggle' => 'import-available-data','data-empty-selection-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/location::bulk-import.choose_country'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['name' => 'country_code','options' => $countries,'searchable' => true,'multiple' => true,'dataPlaceholder' => trans('plugins/location::bulk-import.choose_country'),'helperText' => trans('plugins/location::bulk-import.available_data_help', [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'country_code','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($countries),'searchable' => true,'multiple' => true,'data-placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/location::bulk-import.choose_country')),'helper-text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/location::bulk-import.available_data_help', [
                    'link' => Html::link('https://github.com/botble/locations', attributes: ['target' => '_blank']),
                ]))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'submit','color' => 'primary']); ?>
                <?php echo e(trans('plugins/location::bulk-import.import')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/location/resources/views/partials/import-available-data.blade.php ENDPATH**/ ?>