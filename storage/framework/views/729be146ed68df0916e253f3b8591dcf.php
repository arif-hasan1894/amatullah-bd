<link
    rel="stylesheet"
    href="<?php echo e(asset('vendor/core/core/base/libraries/intl-tel-input/css/intlTelInput-v2.min.css')); ?>"
>
...
<script data-pagespeed-no-defer src="<?php echo e(asset('vendor/core/core/base/libraries/intl-tel-input/js/intlTelInput.min.js')); ?>"></script>
    ...
    (function() {
        ...
        function initPhoneNumberFields() {
            document.querySelectorAll('.js-phone-number-mask[data-country-code-selection="true"]').forEach(function(element) {
                ...
                const searchPlaceholder = <?php echo json_encode(trans('core/base::forms.search_country'), 15, 512) ?>;
                if (itiContainer) {
                                    ...
                                    searchInput.addEventListener('input', function() {
                                        ...
                                        if (visibleCount === 0) {
                                            if (!noResultsEl) {
                                                ...
                                                noResultsEl.textContent = <?php echo json_encode(trans('core/base::forms.no_results'), 15, 512) ?>;
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/base/resources/views/forms/fields/phone-number-script.blade.php ENDPATH**/ ?>