...
<?php endif; ?>
        <span class="badge bg-red text-red-fg badge-pill"><?php echo e(number_format($contacts->total())); ?></span>
    </button>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo BaseHelper::clean(trans('plugins/contact::contact.new_msg_notice', ['count' => $contacts->total()])); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/contact/resources/views/partials/notification.blade.php ENDPATH**/ ?>