...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_pages','label' => 'Update existing pages only','helperText' => 'Existing Pages are matched by slug first, then exact name. Unmatched rows are ignored. Leave unchecked to create missing Pages.','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_pages','label' => 'Update existing pages only','helper-text' => 'Existing Pages are matched by slug first, then exact name. Unmatched rows are ignored. Leave unchecked to create missing Pages.','value' => '1']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/packages/page/resources/views/pages/partials/page-import-extra-fields.blade.php ENDPATH**/ ?>