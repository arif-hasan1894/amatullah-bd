...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['hover' => false,'striped' => false,'class' => 'order-products-table']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['style' => 'width: 45%','class' => 'text-start']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['style' => 'width: 45%','class' => 'text-start']); ?>
                    <div class="d-flex align-items-center flex-wrap">
                        <?php if($editProductRoute && $product->getKey() && $product->original_product->getKey()): ?>
                            <a
                                href="<?php echo e(route($editProductRoute, $product->original_product->getKey())); ?>"
                    ...
                    <?php if(! EcommerceHelper::isDisabledPhysicalProduct() && $order->shipment->id): ?>
                        <ul class="list-unstyled ms-1 small">
                            ...
                            <?php echo apply_filters('ecommerce_order_product_item_extra_info_after', '', $orderProduct, $order); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/orders/edit/order-products.blade.php ENDPATH**/ ?>