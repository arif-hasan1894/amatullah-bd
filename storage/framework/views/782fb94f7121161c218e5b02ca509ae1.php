...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_customers','label' => trans('plugins/ecommerce::customer.import.update_existing_customers'),'helperText' => trans('plugins/ecommerce::customer.import.update_existing_customers_description'),'value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_customers','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::customer.import.update_existing_customers')),'helper-text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::customer.import.update_existing_customers_description')),'value' => '1']); ?>
...
<?php endif; ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/customers/partials/customer-import-extra-fields.blade.php ENDPATH**/ ?>