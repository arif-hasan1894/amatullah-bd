...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'warning','icon' => 'ti ti-alert-circle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','icon' => 'ti ti-alert-circle']); ?>
    <?php echo e(trans('core/base::system.cache_too_large_alert', ['size' => $size])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/base/resources/views/system/partials/cache-too-large-alert.blade.php ENDPATH**/ ?>