        ...
        <div class="ps-section__header">
            ...
            <ul class="ps-section__links">
                <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item">
                        <a class="<?php if($loop->first): ?> active <?php endif; ?>" href="#" data-url="<?php echo e(route('public.ajax.products-by-category', $item->id, ['limit' => $limit])); ?>"><?php echo e($item->name); ?></a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e($category->url); ?>"><?php echo e(__('View All')); ?></a></li>
            </ul>
        </div>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/themes/amatullah/partials/short-codes/product-category-products.blade.php ENDPATH**/ ?>