...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['label' => trans('plugins/ecommerce::shipping.warehouse'),'name' => 'store_id','options' => $storeLocators->pluck('name', 'id')->all(),'value' => $storeLocators->where('is_primary', true)->first() ? $storeLocators->where('is_primary', true)->first()->id : null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping.warehouse')),'name' => 'store_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($storeLocators->pluck('name', 'id')->all()),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($storeLocators->where('is_primary', true)->first() ? $storeLocators->where('is_primary', true)->first()->id : null)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => trans('plugins/ecommerce::shipping.weight_unit', ['unit' => ecommerce_weight_unit()]),'name' => 'weight','value' => $weight,'class' => 'input-mask-number shipment-form-weight']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping.weight_unit', ['unit' => ecommerce_weight_unit()])),'name' => 'weight','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($weight),'class' => 'input-mask-number shipment-form-weight']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="mb-3">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-1"><?php echo e(trans('plugins/ecommerce::shipping.shipping_address')); ?></h4>
            <a class="btn-trigger-update-shipping-address" href="javascript:void(0)"><?php echo e(trans('plugins/ecommerce::shipping.edit')); ?></a>
        </div>

        <div class="shipment-address-box-1">
            <?php echo $__env->make('plugins/ecommerce::orders.shipping-address.line', ['address' => $order->address], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('plugins/ecommerce::shipping.shipping_method')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div id="select-shipping-provider">
                    <div data-bs-toggle="dropdown" aria-expanded="false">
                        <input
                            ...
                            name="method"
                            type="hidden"
                            value="<?php echo e($order->shipping_method); ?>"
                        >
                        <input
                            class="input-hidden-shipping-option"
                            name="option"
                            type="hidden"
                            value="<?php echo e($order->shipping_option); ?>"
                        >
                        <input
                            class="form-control input-show-shipping-method"
                            type="text"
                            value="<?php echo e($order->shipping_method_name); ?>"
                            readonly
                            placeholder="<?php echo e(trans('plugins/ecommerce::shipping.select_shipping_method')); ?>"
                        >
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['class' => 'table-shipping-select-options']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'table-shipping-select-options']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <?php echo e(trans('plugins/ecommerce::shipping.packages')); ?>

                                    <p class="text-warning mb-0">
                                        <?php echo e(trans('plugins/ecommerce::shipping.warehouse')); ?>

                                        <?php echo e(get_ecommerce_setting('store_city')); ?>,
                                        <?php echo e(get_ecommerce_setting('store_state')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <?php echo e(trans('plugins/ecommerce::shipping.shipping_fee_cod')); ?>

                                    <p class="text-warning mb-0">
                                        <?php echo e(trans('plugins/ecommerce::shipping.fee')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php $__currentLoopData = $shipping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shippingKey => $shippingItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $shippingItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subShippingKey => $subShippingItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.row','data' => ['class' => 'clickable-row','dataKey' => ''.e($shippingKey).'','dataOption' => ''.e($subShippingKey).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'clickable-row','data-key' => ''.e($shippingKey).'','data-option' => ''.e($subShippingKey).'']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                                <span class="name"><?php echo e($subShippingItem['name']); ?></span>
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                                <?php echo e(format_price($subShippingItem['price'])); ?>
...
<?php endif; ?>
        ...
        <?php if(
            ...
            <div class="col-md-6">
                <?php if (isset($component)) { $__componentOriginala5b2ce8ea835a1a6ed10854da20fa051 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala5b2ce8ea835a1a6ed10854da20fa051 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => trans('plugins/ecommerce::shipping.cod_amount'),'class' => 'input-mask-number','name' => 'cod_amount','dataThousandsSeparator' => EcommerceHelper::getThousandSeparatorForInputMask(),'dataDecimalSeparator' => EcommerceHelper::getDecimalSeparatorForInputMask(),'value' => format_price($order->amount, null, true),'groupFlat' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::form.text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping.cod_amount')),'class' => 'input-mask-number','name' => 'cod_amount','data-thousands-separator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(EcommerceHelper::getThousandSeparatorForInputMask()),'data-decimal-separator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(EcommerceHelper::getDecimalSeparatorForInputMask()),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(format_price($order->amount, null, true)),'group-flat' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.textarea','data' => ['label' => trans('plugins/ecommerce::shipping.note'),'name' => 'note','class' => 'textarea-auto-height','rows' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping.note')),'name' => 'note','class' => 'textarea-auto-height','rows' => '1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['label' => trans('plugins/ecommerce::shipping.send_confirmation_email_to_customer'),'name' => 'send_mail','value' => 1,'checked' => true,'inline' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping.send_confirmation_email_to_customer')),'name' => 'send_mail','value' => 1,'checked' => true,'inline' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','class' => 'btn-close-shipment-panel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','class' => 'btn-close-shipment-panel']); ?>
                <?php echo e(trans('plugins/ecommerce::shipping.cancel')); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','color' => 'primary','class' => 'btn-create-shipment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'primary','class' => 'btn-create-shipment']); ?>
                <?php echo e(trans('plugins/ecommerce::shipping.finish')); ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/orders/shipment-form.blade.php ENDPATH**/ ?>