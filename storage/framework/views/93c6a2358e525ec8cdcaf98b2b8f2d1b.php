...
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(RAZORPAY_PAYMENT_METHOD_NAME),'paymentName' => 'Razorpay','supportedCurrencies' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($paymentService->supportedCurrencyCodes())]); ?>
        ...
        <?php if(isset($minimumAmount) && isset($orderAmount) && (float) $orderAmount < (float) $minimumAmount): ?>
            <div class="alert alert-warning my-2">
                <?php echo e(trans('plugins/razorpay::razorpay.minimum_amount_warning', ['amount' => format_price($minimumAmount)])); ?>
...
<?php endif; ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                var persistAddressThenCheckout = function(form, done) {
                    var saveUrl = '<?php echo e($rzpSaveInformationUrl); ?>';
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/razorpay/resources/views/methods.blade.php ENDPATH**/ ?>