<ol>
    ...
    <li>
        <p><?php echo e(trans('plugins/sslcommerz::sslcommerz.after_registration', ['name' => 'SslCommerz'])); ?></p>
    </li>
    <li>
        <p><?php echo e(trans('plugins/sslcommerz::sslcommerz.enter_credentials')); ?></p>
    </li>
</ol>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/sslcommerz/resources/views/instructions.blade.php ENDPATH**/ ?>