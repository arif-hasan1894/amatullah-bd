<?php $__env->startSection('title', trans('packages/theme::theme.errors.404_page_not_found')); ?>

<?php $__env->startSection('content'); ?>
    <div class="empty">
        <div class="empty-header">404</div>
        <p class="empty-title"><?php echo e(trans('packages/theme::theme.errors.page_not_found')); ?></p>
        <p class="empty-subtitle text-secondary">
            <?php echo e(trans('packages/theme::theme.errors.page_not_found_description')); ?>
...
<?php echo $__env->make('packages/theme::errors.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/packages/theme/resources/views/errors/404.blade.php ENDPATH**/ ?>