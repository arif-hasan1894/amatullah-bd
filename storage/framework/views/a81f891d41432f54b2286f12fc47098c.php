...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->endSlot(); ?>
            <?php if(MarketplaceHelper::allowVendorManageShipping()): ?>
                <a
                    href="<?php echo e(route('marketplace.vendor.shipments.edit', $shipment->id)); ?>"
                    target="_blank"
                >
...
<?php endif; ?>
    ...
    <?php if($shipment->canPrintLabel()): ?>
        <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('marketplace.vendor.shipments.print', $shipment),'target' => '_blank','icon' => 'ti ti-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('marketplace.vendor.shipments.print', $shipment)),'target' => '_blank','icon' => 'ti ti-printer']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/themes/vendor-dashboard/orders/shipment-detail.blade.php ENDPATH**/ ?>