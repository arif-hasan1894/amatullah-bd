<?php if(is_plugin_active('payment') && $orderAmount): ?>
    ...
    <input
        name="currency"
        type="hidden"
        value="<?php echo e(get_application_currency()->title); ?>"
    >
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/orders/partials/payment-methods.blade.php ENDPATH**/ ?>