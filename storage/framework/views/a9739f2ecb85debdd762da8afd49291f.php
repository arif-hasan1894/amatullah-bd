<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="list-group-item px-0 px-md-2">
        <input
            type="hidden"
            name="up_sale_products[<?php echo e($product->id); ?>][id]"
            value="<?php echo e($product->id); ?>"
        />
        <input
            type="hidden"
            name="up_sale_products[<?php echo e($product->id); ?>][is_variant]"
            value="0"
        />
            ...
            <div class="col text-truncate">
                ...
                <div>
                    ...
                    <?php if($product->isOnSale()): ?>
                        /
                        <span class="text-danger text-decoration-line-through"><?php echo e(format_price($product->display_price)); ?></span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-auto">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => trans('plugins/ecommerce::products.price'),'value' => $product->pivot->price,'name' => 'up_sale_products['.e($product->id).'][price]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.price')),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->pivot->price),'name' => 'up_sale_products['.e($product->id).'][price]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['label' => trans('plugins/ecommerce::products.up_sell_price_type.title'),'options' => \Botble\Ecommerce\Enums\UpSellPriceType::labels(),'value' => $product->pivot->price_type,'name' => 'up_sale_products['.e($product->id).'][price_type]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.up_sell_price_type.title')),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Botble\Ecommerce\Enums\UpSellPriceType::labels()),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->pivot->price_type),'name' => 'up_sale_products['.e($product->id).'][price_type]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.on-off.checkbox','data' => ['label' => trans('plugins/ecommerce::products.apply_for_all_variations'),'name' => 'up_sale_products['.e($product->id).'][apply_to_all_variations]','checked' => $product->pivot->apply_to_all_variations,'dataBbToggle' => 'collapse','dataBbTarget' => '#up-sale-product-variations-'.e($product->id).'','dataBbReverse' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.apply_for_all_variations')),'name' => 'up_sale_products['.e($product->id).'][apply_to_all_variations]','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->pivot->apply_to_all_variations),'data-bb-toggle' => 'collapse','data-bb-target' => '#up-sale-product-variations-'.e($product->id).'','data-bb-reverse' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="list-group" id="up-sale-product-variations-<?php echo e($product->id); ?>" style="<?php echo \Illuminate\Support\Arr::toCssStyles(['display: none' => $product->pivot->apply_to_all_variations]) ?>">
                <?php $__currentLoopData = $product->variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variationProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <input
                        type="hidden"
                        name="up_sale_products[<?php echo e($variationProduct->product->id); ?>][id]"
                        value="<?php echo e($variationProduct->product->id); ?>"
                    />
                    <input
                        type="hidden"
                        name="up_sale_products[<?php echo e($variationProduct->product->id); ?>][parent_id]"
                        value="<?php echo e($product->id); ?>"
                    />
                    <input
                        type="hidden"
                        name="up_sale_products[<?php echo e($variationProduct->product->id); ?>][is_variant]"
                        value="1"
                    />
                    <div class="list-group-item">
                        ...
                        <div class="row">
                            <div class="col">
                                <?php if (isset($component)) { $__componentOriginala5b2ce8ea835a1a6ed10854da20fa051 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala5b2ce8ea835a1a6ed10854da20fa051 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => trans('plugins/ecommerce::products.price'),'value' => $variationProduct->product?->pivot?->price,'name' => 'up_sale_products['.e($variationProduct->product->id).'][price]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::form.text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.price')),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($variationProduct->product?->pivot?->price),'name' => 'up_sale_products['.e($variationProduct->product->id).'][price]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala5b2ce8ea835a1a6ed10854da20fa051)): ?>
<?php $attributes = $__attributesOriginala5b2ce8ea835a1a6ed10854da20fa051; ?>
...
<?php endif; ?>
                            ...
                            <div class="col">
                                <?php if (isset($component)) { $__componentOriginald8f3cab0e02bd6920e9589a31228d9ca = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8f3cab0e02bd6920e9589a31228d9ca = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['label' => trans('plugins/ecommerce::products.up_sell_price_type.title'),'options' => \Botble\Ecommerce\Enums\UpSellPriceType::labels(),'value' => $variationProduct->product?->pivot?->price_type,'name' => 'up_sale_products['.e($variationProduct->product->id).'][price_type]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::form.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.up_sell_price_type.title')),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Botble\Ecommerce\Enums\UpSellPriceType::labels()),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($variationProduct->product?->pivot?->price_type),'name' => 'up_sale_products['.e($variationProduct->product->id).'][price_type]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8f3cab0e02bd6920e9589a31228d9ca)): ?>
<?php $attributes = $__attributesOriginald8f3cab0e02bd6920e9589a31228d9ca; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/selected-up-sell-products.blade.php ENDPATH**/ ?>