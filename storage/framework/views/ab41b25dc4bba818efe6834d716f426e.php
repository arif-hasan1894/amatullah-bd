...
<?php if(isset($options['choices']) &&
    ...
    <?php if(count($options['choices']) < Arr::get($options, 'switch_to_dropdown_threshold', 50)): ?>
        <div class="mb-3">
...
<?php endif; ?>
        ...
        <div
            ...
            class="tree-categories-list-<?php echo e($inputSearchId); ?>"
        >
...
<?php endif; ?>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/base/resources/views/forms/fields/tree-categories.blade.php ENDPATH**/ ?>