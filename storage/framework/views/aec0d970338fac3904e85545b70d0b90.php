...
<button
    ...
    aria-label="<?php echo e(trans('plugins/ecommerce::products.compare.add_another')); ?>"
>
...
<?php endif; ?>
    ...
    <span class="compare-add-slot-label">
        <?php echo e(trans('plugins/ecommerce::products.compare.add_another')); ?>

    </span>
</button>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/includes/compare-add-slot.blade.php ENDPATH**/ ?>