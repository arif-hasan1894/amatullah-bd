...
<?php $component->withAttributes([]); ?>
                ...
                <?php $__currentLoopData = $returnRequest->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $returnRequestItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $orderProduct = $returnRequestItem->orderProduct;
                        $product = $orderProduct?->product;
                    ?>

                    <?php if(! $orderProduct || ! $product) continue; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php if($product->id && $product->original_product->id): ?>
                                <a
                                    href="<?php echo e(route($productEditRouteName, $product->original_product->id)); ?>"
                                    title="<?php echo e($returnRequestItem->product_name); ?>"
                                    target="_blank"
                                ><?php echo e($returnRequestItem->product_name); ?></a>
                            <?php else: ?>
                                <span><?php echo e($returnRequestItem->product_name); ?></span>
                            <?php endif; ?>
                            <?php if($orderProduct->options): ?>
...
<?php $component->withAttributes(['class' => 'text-end']); ?>
                            <?php echo e(format_price($returnRequestItem->price_with_tax)); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'text-start text-danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-start text-danger']); ?>
                            <?php echo e($returnRequestItem->qty); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>
                            <?php echo e(format_price($returnRequestItem->refund_amount)); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['colspan' => '3','class' => 'text-end']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '3','class' => 'text-end']); ?>
                            <?php echo e(trans('plugins/ecommerce::order.total_return_amount')); ?>:
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>
                            <?php echo e(format_price($returnRequest->items->sum('refund_amount'))); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'text-end','colspan' => '3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end','colspan' => '3']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>
                            <?php echo BaseHelper::clean($returnRequest->return_status->toHtml()); ?>
...
<?php if($returnRequest->images && count($returnRequest->images)): ?>
    <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card'); ?>
...
<?php $component->withAttributes([]); ?>
            <div class="row g-2">
                <?php $__currentLoopData = $returnRequest->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-auto">
                        <a href="<?php echo e(RvMedia::getImageUrl($image)); ?>" target="_blank" class="d-block">
                            <img
                                src="<?php echo e(RvMedia::getImageUrl($image, 'thumb')); ?>"
                                alt="<?php echo e(trans('plugins/ecommerce::order.return_image')); ?>"
                                class="img-thumbnail"
...
<?php if(! in_array($returnRequest->return_status, [
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(trans('plugins/ecommerce::order.change_return_order_status')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php if($returnRequest->return_status != Botble\Ecommerce\Enums\OrderReturnStatusEnum::PROCESSING): ?>
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','color' => 'primary','icon' => 'ti ti-circle-check','dataBsToggle' => 'modal','dataBsTarget' => '#approve-order-return-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'primary','icon' => 'ti ti-circle-check','data-bs-toggle' => 'modal','data-bs-target' => '#approve-order-return-modal']); ?>
                    <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.approve_button')); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','color' => 'danger','outlined' => true,'icon' => 'ti ti-x','dataBsToggle' => 'modal','dataBsTarget' => '#reject-order-return-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'danger','outlined' => true,'icon' => 'ti ti-x','data-bs-toggle' => 'modal','data-bs-target' => '#reject-order-return-modal']); ?>
                    <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.reject_button')); ?>
...
<?php endif; ?>
            <?php else: ?>
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'button','color' => 'success','icon' => 'ti ti-circle-check','dataBsToggle' => 'modal','dataBsTarget' => '#mark-as-completed-order-return-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','color' => 'success','icon' => 'ti ti-circle-check','data-bs-toggle' => 'modal','data-bs-target' => '#mark-as-completed-order-return-modal']); ?>
                    <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.mark_as_completed_button')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['id' => 'approve-order-return-modal','title' => trans('plugins/ecommerce::order.order_return_moderation.approve_confirmation_title'),'type' => 'success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'approve-order-return-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::order.order_return_moderation.approve_confirmation_title')),'type' => 'success']); ?>
        <p class="text-secondary">
            <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.approve_confirmation_description')); ?>

        </p>

        <?php echo \Botble\Ecommerce\Forms\ModerateOrderReturnForm::create()
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldc8ac54b6bf7eb0d0560fdd5aa630687 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldc8ac54b6bf7eb0d0560fdd5aa630687 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['id' => 'reject-order-return-modal','title' => trans('plugins/ecommerce::order.order_return_moderation.reject_confirmation_title'),'type' => 'danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reject-order-return-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::order.order_return_moderation.reject_confirmation_title')),'type' => 'danger']); ?>
        <p class="text-secondary">
            <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.reject_confirmation_description')); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldc8ac54b6bf7eb0d0560fdd5aa630687 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldc8ac54b6bf7eb0d0560fdd5aa630687 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['id' => 'mark-as-completed-order-return-modal','title' => trans('plugins/ecommerce::order.order_return_moderation.mark_as_completed_confirmation_title'),'type' => 'success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'mark-as-completed-order-return-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::order.order_return_moderation.mark_as_completed_confirmation_title')),'type' => 'success']); ?>
        <p class="text-secondary">
            <?php echo e(trans('plugins/ecommerce::order.order_return_moderation.mark_as_completed_confirmation_description')); ?>
...
<?php $component->withAttributes([]); ?>
        <ul class="steps steps-vertical border-0 p-0 m-0">
            <?php $__currentLoopData = $returnRequest->histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="<?php echo \Illuminate\Support\Arr::toCssClasses(['step-item', 'user-action' => $loop->first]); ?>">
                    <div class="h4 m-0"><?php echo e($history->description); ?></div>
                    <div class="d-flex justify-content-between">
                        <div class="text-secondary">
                            <?php if($history->reason): ?>
                                <?php echo e(trans('plugins/ecommerce::order.cancellation_reason', ['reason' => $history->reason])); ?>

                            <?php endif; ?>
                        </div>
                        <div class="text-secondary"><?php echo e($history->created_at); ?></div>
                    </div>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
...
<?php unset($__componentOriginalc107e2f90dff5eb05519f33918d2c807); ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/order-returns/partials/order-information.blade.php ENDPATH**/ ?>