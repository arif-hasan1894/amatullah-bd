...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_post_translations','label' => 'Update existing product translations only','helperText' => 'Only existing Product translation rows will be updated. Missing translation rows and unknown Product IDs are ignored. Leave unchecked to create missing translation rows for existing Products.','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_post_translations','label' => 'Update existing product translations only','helper-text' => 'Only existing Product translation rows will be updated. Missing translation rows and unknown Product IDs are ignored. Leave unchecked to create missing translation rows for existing Products.','value' => '1']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/product-translation-import-extra-fields.blade.php ENDPATH**/ ?>