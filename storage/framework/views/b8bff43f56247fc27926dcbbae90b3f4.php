<?php $__env->startSection('content'); ?>
    <div
        ...
        data-routes="<?php echo e(json_encode([
        ...
        data-confirm-delete="<?php echo e(trans('core/base::tables.confirm_delete')); ?>"
        data-confirm-bulk-delete="<?php echo e(trans('plugins/ecommerce::products.license_codes.bulk_delete.confirm')); ?>"
    >
    <div class="row">
        <div class="col-md-12">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(trans('plugins/ecommerce::products.license_codes.title')); ?> - <?php echo e($product->name); ?>

                        <?php if($product->is_variation): ?>
                            <small class="text-muted">(<?php echo e(trans('plugins/ecommerce::products.license_codes.variation_label')); ?>)</small>
                        <?php endif; ?>
...
<?php endif; ?>
                    <div class="card-actions">
                        <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="btn btn-ghost-secondary">
...
<?php endif; ?>
                            <?php echo e(trans('plugins/ecommerce::products.license_codes.back')); ?>
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="<?php echo e(route('tools.data-synchronize.import.product-license-codes.index')); ?>" class="dropdown-item">
                                        <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                        <?php echo e(trans('plugins/ecommerce::products.license_codes.import.button')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'danger','class' => 'mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['type' => 'danger','class' => 'mb-3']); ?>
                            <strong><?php echo e(trans('plugins/ecommerce::products.license_codes.out_of_stock_title')); ?></strong><br>
                            <?php echo e(trans('plugins/ecommerce::products.license_codes.out_of_stock_message')); ?>
...
<?php endif; ?>
                    <?php elseif($showLowStockWarning): ?>
                        <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
...
<?php $component->withAttributes(['type' => 'warning','class' => 'mb-3']); ?>
                            <strong><?php echo e(trans('plugins/ecommerce::products.license_codes.low_stock_title')); ?></strong><br>
                            <?php echo e(trans('plugins/ecommerce::products.license_codes.low_stock_message', ['count' => $availableCount])); ?>
...
<?php endif; ?>
                    ...
                    <?php if($licenseCodes->count() > 0): ?>
                        <div class="mb-3 bulk-actions-wrapper" style="display: none;">
                            <div class="d-flex align-items-center gap-2">
                                <span class="text-muted">
                                    <span class="selected-count fw-bold">0</span> <?php echo e(trans('plugins/ecommerce::products.license_codes.bulk_delete.selected')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                    <?php echo e(trans('plugins/ecommerce::products.license_codes.bulk_delete.button')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <?php echo e(trans('core/base::tables.operations')); ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                            <?php if($licenseCode->isAvailable()): ?>
                                                <input type="checkbox" class="form-check-input license-code-checkbox" data-id="<?php echo e($licenseCode->id); ?>" />
                                            <?php endif; ?>
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                            <code><?php echo e($licenseCode->license_code); ?></code>
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                            <?php echo e(BaseHelper::formatDate($licenseCode->created_at)); ?>
...
<?php $component->withAttributes([]); ?>
                                            <?php if($licenseCode->isAvailable()): ?>
                                                <button type="button"
                                                        ...
                                                        data-license-code-id="<?php echo e($licenseCode->id); ?>"
                                                        data-license-code="<?php echo e($licenseCode->license_code); ?>">
                                                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                                    <?php echo e(trans('core/base::tables.edit')); ?>
...
<?php endif; ?>
                                            ...
                                            <?php else: ?>
                                                <span class="text-muted"><?php echo e(trans('plugins/ecommerce::products.license_codes.used_code_no_actions')); ?></span>
                                            <?php endif; ?>
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
...
<?php endif; ?>
                        ...
                        <div class="mt-3">
                            <?php echo $licenseCodes->links(); ?>

                        </div>
                    <?php else: ?>
                        <?php if($product->license_code_type === 'pick_from_list'): ?>
                            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
...
<?php $component->withAttributes(['type' => 'warning']); ?>
                                <strong><?php echo e(trans('plugins/ecommerce::products.license_codes.no_codes_warning_title')); ?></strong><br>
                                <?php echo e(trans('plugins/ecommerce::products.license_codes.no_codes_warning_message')); ?>
...
<?php $component->withAttributes(['type' => 'info']); ?>
                                <?php echo e(trans('plugins/ecommerce::products.license_codes.no_codes_auto_generate')); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('plugins/ecommerce::products.license-codes.modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('footer'); ?>
    <?php echo e(Html::script('vendor/core/plugins/ecommerce/js/product-license-codes.js')); ?>

<?php $__env->stopPush(); ?>

<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/license-codes/index.blade.php ENDPATH**/ ?>