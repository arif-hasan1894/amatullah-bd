<?php if(!$order->dont_show_order_info_in_product_list): ?>
    <a
        ...
        href="<?php echo e($order->getOrderTrackingUrl()); ?>"
    ><?php echo e(trans('plugins/ecommerce::email.view_order')); ?></a>
    <?php echo BaseHelper::clean(trans('plugins/ecommerce::email.link_go_to_our_shop', ['link' => BaseHelper::getHomepageUrl()])); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!$order->dont_show_order_info_in_product_list): ?>
            ...
            <?php if((float) ($order->shipping_tax_amount ?? 0)): ?>
                <tr>
                    <td colspan="2" class="bb-text-right"><?php echo e(trans('plugins/ecommerce::order.shipping_tax')); ?></td>
                    <td colspan="2" class="bb-text-right"><?php echo e(format_price($order->shipping_tax_amount)); ?></td>
                </tr>
            <?php endif; ?>
            ...
            <?php if((float)$order->payment_fee): ?>
                <tr>
                    <td colspan="2" class="bb-text-right"><?php echo e(trans('plugins/payment::payment.payment_fee')); ?></td>
                    <td colspan="2" class="bb-text-right"><?php echo e(format_price($order->payment_fee)); ?></td>
                </tr>
            <?php endif; ?>
            <tr>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/emails/partials/order-detail.blade.php ENDPATH**/ ?>