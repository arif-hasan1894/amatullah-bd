...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mb-3 payment-method-item','dataPaymentType' => ''.e($id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3 payment-method-item','data-payment-type' => ''.e($id).'']); ?>
...
<?php $component->withAttributes(['class' => 'border-end','style' => 'width: 40px;']); ?>
                    <button type="button" class="btn btn-icon btn-sm set-default-payment-method <?php if($isDefault): ?> text-warning <?php else: ?> text-muted <?php endif; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(trans('plugins/payment::payment.default_payment_method')); ?>">
                        <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-star'.e($isDefault ? '-filled' : '').''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/payment/resources/views/components/settings-card.blade.php ENDPATH**/ ?>