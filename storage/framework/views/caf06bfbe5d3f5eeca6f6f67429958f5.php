...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'info','icon' => 'ti ti-alert-circle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'info','icon' => 'ti ti-alert-circle']); ?>
    <?php echo BaseHelper::clean(trans('plugins/backup::backup.demo_alert', ['link' => route('backups.index')])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/backup/resources/views/partials/admin-alert.blade.php ENDPATH**/ ?>