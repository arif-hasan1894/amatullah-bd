...
<?php $component->withAttributes(['type' => 'info','class' => 'bg-white text-info']); ?>
                <div class="d-flex align-items-center">
                    <div>
                        <?php echo e(trans('plugins/ecommerce::product-categories.table_view_info')); ?>

                        <a href="<?php echo e(route('product-categories.index', ['as' => 'table'])); ?>" class="text-decoration-underline">
                            <?php echo e(trans('plugins/ecommerce::product-categories.manage_as_table')); ?>
...
<?php echo $__env->make($layout ?? BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/product-categories/form-tree-category.blade.php ENDPATH**/ ?>