...
<style>
    ...
    .site-notice .site-notice-body {
        ...
        max-width: min(<?php echo e($maxWidth); ?>px, 640px);
        max-height: 90vh;
        overflow-y: auto;
        padding: 24px 32px;
...
<div
    ...
    aria-live="polite"
    style="--cc-primary: <?php echo e($primaryColor); ?>; --cc-primary-hover: <?php echo e($primaryColorHover); ?>; --cc-accent-text: <?php echo e($accentTextColor); ?>;"
    data-nosnippet
>
    <div class="site-notice-body">
        
        <p class="site-notice__visually-hidden" id="js-site-notice-title"><?php echo e($popupTitle); ?></p>

        <div class="site-notice__top">
            <button type="button" class="js-site-notice-reject site-notice__link">
                <?php echo e(trans('plugins/cookie-consent::cookie-consent.continue_without_accepting_text')); ?>

            </button>
        </div>

        <p class="site-notice__message">
            <?php echo BaseHelper::clean($popupMessage); ?>

            <?php if($learnMoreUrl && $learnMoreText): ?>
                <a href="<?php echo e(Str::startsWith($learnMoreUrl, ['http://', 'https://']) ? $learnMoreUrl : BaseHelper::getHomepageUrl() . '/' . ltrim($learnMoreUrl, '/')); ?>"><?php echo e($learnMoreText); ?></a>
            <?php endif; ?>
        </p>

        <div class="site-notice__actions">
            <?php if($showCustomize): ?>
            ...
            <button type="button" class="js-site-notice-essential site-notice__secondary">
                <?php echo e(trans('plugins/cookie-consent::cookie-consent.essential_only_text')); ?>

            </button>
            <button type="button" class="js-site-notice-accept-all site-notice__accept-all">
                <?php echo e(trans('plugins/cookie-consent::cookie-consent.accept_all_text')); ?>
    ...
    <?php if($hasCategories): ?>
        <?php echo $__env->make('plugins/cookie-consent::partials.preferences-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
</div>

<?php echo $__env->make('plugins/cookie-consent::partials.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/cookie-consent/resources/views/styles/popup.blade.php ENDPATH**/ ?>