...
<body>
    <div class="container">
        ...
        <div class="controls-section">
            <div class="controls-header">
                <h2><?php echo e(trans('core/setting::setting.preview')); ?></h2>
                <p><?php echo e(trans('core/setting::setting.enter_sample_value')); ?></p>
            </div>
            <form
                method="POST"
                id="preview-form"
    ...
    <script>
        (function() {
            ...
            const baseIframeUrl = '<?php echo e($iframeUrl); ?>';
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/core/setting/resources/views/preview-email.blade.php ENDPATH**/ ?>