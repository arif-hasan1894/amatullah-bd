...
<?php $component->withAttributes(['type' => 'warning']); ?>
                    <ul class="mb-0 list-unstyled">
                        <li><?php echo e(trans('core/base::system.cleanup.backup_alert')); ?></li>
                        <?php if(!config('core.base.general.enabled_cleanup_database', false)): ?>
                            <li class="mt-2"><?php echo BaseHelper::clean(trans('core/base::system.cleanup.not_enabled_yet')); ?></li>
                        <?php endif; ?>
                    </ul>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('core/base::system.cleanup.messenger_choose_without_table')); ?>: <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['url' => route('system.cleanup'),'method' => 'post','id' => 'form-cleanup-database']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('system.cleanup')),'method' => 'post','id' => 'form-cleanup-database']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                            <?php echo e(trans('core/base::system.cleanup.table.name')); ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                            <?php echo e(trans('core/base::system.cleanup.table.count')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                                <?php echo e(DB::table($table)->count()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['color' => 'danger','icon' => 'ti ti-alert-triangle','class' => 'btn-trigger-cleanup']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'danger','icon' => 'ti ti-alert-triangle','class' => 'btn-trigger-cleanup']); ?>
                            <?php echo e(trans('core/base::system.cleanup.submit_button')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal.action','data' => ['id' => 'cleanup-modal','title' => trans('core/base::system.cleanup.title'),'description' => trans('core/base::system.cleanup.messenger_confirm_cleanup'),'type' => 'danger','submitButtonLabel' => trans('core/base::system.cleanup.submit_button'),'submitButtonAttrs' => ['id' => 'cleanup-submit-action']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'cleanup-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::system.cleanup.title')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::system.cleanup.messenger_confirm_cleanup')),'type' => 'danger','submit-button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::system.cleanup.submit_button')),'submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['id' => 'cleanup-submit-action'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/core/base/resources/views/system/cleanup.blade.php ENDPATH**/ ?>