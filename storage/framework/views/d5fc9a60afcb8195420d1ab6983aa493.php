...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['class' => 'create-tax-rule-form-modal','type' => 'info','title' => trans('plugins/ecommerce::tax.rule.create'),'bodyAttrs' => ['data-select2-dropdown-parent']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'create-tax-rule-form-modal','type' => 'info','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::tax.rule.create')),'body-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['data-select2-dropdown-parent'])]); ?>
    ...
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/taxes/rules/form-modal.blade.php ENDPATH**/ ?>