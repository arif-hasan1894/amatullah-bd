...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'info','class' => 'mt-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'info','class' => 'mt-3']); ?>
            <h4 class="alert-title"><?php echo e(trans('plugins/ecommerce::setting.store_locator.info.title')); ?></h4>
            <ul class="mb-0">
                <li><?php echo e(trans('plugins/ecommerce::setting.store_locator.info.primary_store')); ?></li>
                <li><?php echo e(trans('plugins/ecommerce::setting.store_locator.info.shipping_location')); ?></li>
                <li><?php echo e(trans('plugins/ecommerce::setting.store_locator.info.shipment_selection')); ?></li>
            </ul>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['id' => 'delete-store-locator-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::setting.store_locator.form.delete_location')),'size' => 'md']); ?>
        <?php echo BaseHelper::clean(trans('plugins/ecommerce::setting.store_locator.form.delete_location_confirmation')); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/settings/store-locator.blade.php ENDPATH**/ ?>