<?php $__env->startSection('title', trans('plugins/ecommerce::customer-dashboard.order_information')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="bb-customer-content-wrapper">
        ...
        <?php if($order->isPaymentProofEnabled()): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'payment-icon']); ?>
...
<?php endif; ?>
                        ...
                        <div class="bb-payment-proof-card-details">
                            <h5 class="bb-payment-proof-card-title"><?php echo e(trans('plugins/ecommerce::customer-dashboard.payment_proof')); ?></h5>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['method' => 'post','files' => true,'class' => 'customer-order-upload-receipt','url' => route('customer.orders.upload-proof', $order)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['method' => 'post','files' => true,'class' => 'customer-order-upload-receipt','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('customer.orders.upload-proof', $order))]); ?>
                                <div class="bb-payment-proof-card-content-inner">
                                    <div class="bb-payment-proof-card-message">
                                        <?php if(! $order->proof_file): ?>
                                            <p class="mb-3"><?php echo e(trans('plugins/ecommerce::customer-dashboard.payment_proof_upload_description')); ?></p>
                                        <?php else: ?>
                                            <p class="mb-2"><?php echo e(trans('plugins/ecommerce::customer-dashboard.uploaded_payment_proof')); ?></p>
                                            <div class="bb-payment-proof-card-file mb-3 bg-light">
                                                <span class="label"><?php echo e(trans('plugins/ecommerce::customer-dashboard.view_receipt')); ?></span>
                                                <a href="<?php echo e(route('customer.orders.download-proof', $order)); ?>" target="_blank" class="value">
                                                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php endif; ?>
                                            ...
                                            <p class="mb-3 fw-medium"><?php echo e(trans('plugins/ecommerce::customer-dashboard.upload_new_receipt_description')); ?></p>
                                        <?php endif; ?>
                                    </div>
...
<?php endif; ?>
                                                ...
                                                <div class="bb-file-text">
                                                    <span class="bb-file-placeholder"><?php echo e(trans('plugins/ecommerce::customer-dashboard.choose_file')); ?></span>
                                                    <span class="bb-file-name"></span>
                                                </div>
                                                <span class="bb-file-button"><?php echo e(trans('plugins/ecommerce::customer-dashboard.browse')); ?></span>
                                            </label>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                                <?php echo e(trans('plugins/ecommerce::customer-dashboard.upload')); ?>

                                            </button>
                                        </div>
                                        <small class="text-muted d-block mt-2"><?php echo e(trans('plugins/ecommerce::customer-dashboard.upload_file_types_description')); ?></small>
                                    </div>
                                </div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php echo apply_filters('ecommerce_customer_order_view_before_actions', null, $order); ?>


        <div class="bb-order-actions d-flex flex-wrap gap-2 mt-3">
            <?php if($order->shipment->can_confirm_delivery): ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('plugins/ecommerce::customer-dashboard.confirm_delivery')); ?>

                </button>
            <?php endif; ?>
            <?php if($order->isInvoiceAvailable()): ?>
                <a class="btn btn-success" href="<?php echo e(route('customer.print-order', $order->id)); ?>?type=print" target="_blank">
                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('plugins/ecommerce::customer-dashboard.print_invoice')); ?>

                </a>
                <a class="btn btn-success" href="<?php echo e(route('customer.print-order', $order->id)); ?>">
                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('plugins/ecommerce::customer-dashboard.download_invoice')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('plugins/ecommerce::customer-dashboard.cancel_order')); ?>

                </a>
            <?php endif; ?>
            <?php if($order->canBeReturned()): ?>
                <a class="btn btn-danger" href="<?php echo e(route('customer.order_returns.request_view', $order->id)); ?>">
                    <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-arrow-back-up'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('plugins/ecommerce::customer-dashboard.return_products')); ?>
...
<?php $attributes = $attributes->except(\Botble\Icon\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-warning me-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73995948b3bd877b76251b40caf28170)): ?>
<?php $attributes = $__attributesOriginal73995948b3bd877b76251b40caf28170; ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                <?php echo e(trans('plugins/ecommerce::customer-dashboard.cancel_order_title')); ?>

                            </h4>
                            <p class="text-muted mb-0 mt-2"><?php echo e(trans('plugins/ecommerce::customer-dashboard.cancel_order_reason_description')); ?></p>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body bb-modal-body">
                        <?php echo $cancelOrderForm->renderForm(); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                            <?php echo e(trans('plugins/ecommerce::customer-dashboard.close')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                            <?php echo e(trans('plugins/ecommerce::customer-dashboard.submit')); ?>
        ...
        <div class="modal fade" id="confirmDeliveredModal" tabindex="-1" aria-labelledby="confirmDeliveredModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bb-modal-content">
                    ...
                    <form action="<?php echo e(route('customer.orders.confirm-delivery', $order)); ?>" method="post" class="modal-body text-center bb-modal-body">
                        <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Botble\Icon\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-white','style' => 'width: 2rem; height: 2rem;']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73995948b3bd877b76251b40caf28170)): ?>
<?php $attributes = $__attributesOriginal73995948b3bd877b76251b40caf28170; ?>
...
<?php endif; ?>
                        ...
                        <h5 class="modal-title mb-2 fw-semibold" id="confirmDeliveredModalLabel"><?php echo e(trans('plugins/ecommerce::customer-dashboard.confirm_delivery')); ?></h5>
                        <p class="mb-4 text-muted small"><?php echo e(trans('plugins/ecommerce::customer-dashboard.confirm_delivery_description')); ?></p>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                                <?php echo e(trans('plugins/ecommerce::customer-dashboard.confirm')); ?>
...
<?php echo $__env->make(EcommerceHelper::viewPath('customers.master'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/themes/customers/orders/view.blade.php ENDPATH**/ ?>