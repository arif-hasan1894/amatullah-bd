...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_post_translations','label' => 'Update existing post translations only','helperText' => 'Only translation rows that already exist will be updated. Missing translations and unknown Post IDs will be ignored. Leave unchecked to create missing translation rows for existing Posts.','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_post_translations','label' => 'Update existing post translations only','helper-text' => 'Only translation rows that already exist will be updated. Missing translations and unknown Post IDs will be ignored. Leave unchecked to create missing translation rows for existing Posts.','value' => '1']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/blog/resources/views/posts/partials/post-translation-import-extra-fields.blade.php ENDPATH**/ ?>