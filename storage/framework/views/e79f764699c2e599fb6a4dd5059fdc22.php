...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/ecommerce::ecommerce.product')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <a href="<?php echo e($item->product->url); ?>" target="_blank" class="d-flex gap-2 align-items-center">
                        <?php echo e(RvMedia::image($item->product->image, attributes: ['class' => 'rounded', 'width' => 38])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(BaseHelper::formatDateTime($item->created_at)); ?>
...
<?php $component->withAttributes(['colspan' => '7']); ?>
                    <?php echo e(trans('core/table::table.no_data')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/customers/wishlist.blade.php ENDPATH**/ ?>