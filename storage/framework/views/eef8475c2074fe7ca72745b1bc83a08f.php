...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['name' => 'update_existing_post_translations','label' => 'Update existing product category translations only','helperText' => 'Only existing Product Category translation rows will be updated. Missing translation rows and unknown Product Category IDs are ignored. Leave unchecked to create missing translation rows for existing Product Categories.','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'update_existing_post_translations','label' => 'Update existing product category translations only','helper-text' => 'Only existing Product Category translation rows will be updated. Missing translation rows and unknown Product Category IDs are ignored. Leave unchecked to create missing translation rows for existing Product Categories.','value' => '1']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/product-categories/partials/product-category-translation-import-extra-fields.blade.php ENDPATH**/ ?>