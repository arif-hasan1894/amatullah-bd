...
<?php endif; ?>
        ...
        <?php if(EcommerceHelper::isReviewEnabled() && (!EcommerceHelper::hideRatingWhenNoReviews() || $store->reviews->count() > 0)): ?>
            <div class="d-flex align-items-center gap-1 bb-store-item-rating">
                ...
                <a href="<?php echo e($store->url); ?>" class="small"><?php echo e(trans('plugins/ecommerce::review.count_reviews', ['count' => number_format($store->reviews->count())])); ?></a>
            </div>
        <?php endif; ?>

        <?php if(! MarketplaceHelper::hideStoreAddress() && $store->full_address): ?>
            <p class="bb-store-item-info text-truncate" title="<?php echo e($store->full_address); ?>">
                <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php $component = $__componentOriginal73995948b3bd877b76251b40caf28170; ?>
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?><?php echo e($store->full_address); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                <?php echo e(Html::mailto($store->email)); ?>
    ...
    <div class="bb-store-item-footer">
        <div class="bb-store-item-logo">
            <a href="<?php echo e($store->url); ?>">
                <?php echo e(RvMedia::image($store->logo, $store->name, useDefaultImage: true)); ?>

            </a>
        </div>

        <div class="bb-store-item-action">
            <a href="<?php echo e($store->url); ?>" class="btn btn-primary">
                <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                <?php echo e(trans('plugins/marketplace::store.visit_store')); ?>

            </a>
        </div>
    </div>
</div>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/themes/includes/store-item.blade.php ENDPATH**/ ?>