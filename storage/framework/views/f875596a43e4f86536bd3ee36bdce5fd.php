...
<div class="js-cookie-consent-modal cookie-consent-modal" role="dialog" aria-modal="true" aria-labelledby="js-cookie-consent-modal-title">
    <div class="cookie-consent-modal__dialog">
        <div class="cookie-consent-modal__header">
            <p class="cookie-consent-modal__title" id="js-cookie-consent-modal-title"><?php echo e(trans('plugins/cookie-consent::cookie-consent.customize_text')); ?></p>
            <button
                type="button"
        ...
        <div class="cookie-consent-modal__body">
            <p class="cookie-consent-modal__intro"><?php echo BaseHelper::clean(theme_option('cookie_consent_message', trans('plugins/cookie-consent::cookie-consent.message'))); ?></p>
                ...
                <label class="cookie-consent-modal__item">
                    <span class="cookie-consent-modal__item-head">
                        <span class="cookie-consent-modal__item-name">
                            <?php echo e(trans('plugins/cookie-consent::cookie-consent.cookie_categories.' . $key . '.name')); ?>

                        </span>
                        <?php if($category['required']): ?>
                            <span class="cookie-consent-modal__badge">
                                <?php echo e(trans('plugins/cookie-consent::cookie-consent.always_active')); ?>

                            </span>
                            <input type="checkbox" class="js-cookie-category" value="<?php echo e($key); ?>" checked disabled hidden>
                        <?php else: ?>
                            <span class="cookie-consent-modal__switch">
                                <input type="checkbox" class="js-cookie-category" value="<?php echo e($key); ?>">
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/cookie-consent/resources/views/partials/preferences-modal.blade.php ENDPATH**/ ?>