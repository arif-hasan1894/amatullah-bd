<?php $__env->startSection('pageTitle', trans('packages/installer::installer.install_step_title', ['step' => 4, 'title' =>
...
<?php $component->withAttributes(['class' => 'text-start']); ?>
            <?php echo e(trans('packages/installer::installer.theme_preset.title')); ?>
...
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('packages/installer::installer.theme_preset.message')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['url' => route('installers.theme-presets.store'),'method' => 'post','id' => 'choose-theme-form']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('installers.theme-presets.store')),'method' => 'post','id' => 'choose-theme-form']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.image-check','data' => ['name' => 'theme_preset','options' => $themePresets,'value' => old('theme_preset', array_key_first($themePresets))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'theme_preset','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($themePresets),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('theme_preset', array_key_first($themePresets)))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'submit','color' => 'primary','form' => 'choose-theme-form']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','color' => 'primary','form' => 'choose-theme-form']); ?>
        <?php echo e(trans('packages/installer::installer.next')); ?>
...
<?php echo $__env->make('packages/installer::layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dev.amatullah.bd/platform/packages/installer/resources/views/theme-preset.blade.php ENDPATH**/ ?>