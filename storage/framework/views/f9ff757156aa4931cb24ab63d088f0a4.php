...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'submit','name' => 'submit','value' => 'save','color' => 'primary','icon' => 'ti ti-coin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','name' => 'submit','value' => 'save','color' => 'primary','icon' => 'ti ti-coin']); ?>
            <?php echo e($saveTitle ?? trans('plugins/marketplace::withdrawal.request')); ?>
...
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/marketplace/resources/views/withdrawals/forms/actions.blade.php ENDPATH**/ ?>