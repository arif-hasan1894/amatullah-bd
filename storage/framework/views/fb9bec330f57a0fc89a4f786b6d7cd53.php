...
<?php elseif(is_in_admin(true) && Auth::check() && Auth::user()->hasPermission('product-attribute-sets.create')): ?>
    <p class="text-muted mb-0">
        <?php echo BaseHelper::clean(trans('plugins/ecommerce::products.form.create_product_variations', [
            'link' => Html::link(
...
<?php if (! $__env->hasRenderedOnce('32604c52-c4f8-4bf8-a8d8-796baa374838')): $__env->markAsRenderedOnce('32604c52-c4f8-4bf8-a8d8-796baa374838'); ?>
    <?php if(request()->ajax()): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/add-product-attributes.blade.php ENDPATH**/ ?>