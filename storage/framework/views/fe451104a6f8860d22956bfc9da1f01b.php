...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.checkbox','data' => ['label' => $attributeSet->title,'class' => 'attribute-set-item','name' => 'attribute_sets[]','value' => $attributeSet->id,'checked' => $attributeSet->is_selected,'inline' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributeSet->title),'class' => 'attribute-set-item','name' => 'attribute_sets[]','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributeSet->id),'checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributeSet->is_selected),'inline' => true]); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dev.amatullah.bd/platform/plugins/ecommerce/resources/views/products/partials/attribute-sets.blade.php ENDPATH**/ ?>